...
--- @loaded_in_battle
--- @loaded_in_campaign
--- @class objectives_manager objectives_manager Objectives Manager
...
function objectives_manager:update_objectives_position()
	...
	if self.uic_objectives:CurrentAnimationId() == "" and (not infotext:get_uicomponent() or infotext:get_uicomponent():CurrentAnimationId() == "") then
