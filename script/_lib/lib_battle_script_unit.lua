...
--
--- @loaded_in_battle
---	@class script_unit script_unit Script Unit
...
--- @p [opt=nil] object exception sunit(s), Exception @script_unit or @script_units collection. If this unit comes within 30m of any unit specified here, the <code>max_casualties</code> monitor will temporarily cease and they will become vulnerable to casualties.
...
--	SCRIPT_UNITS
--
---	@class script_units script_units Scriptunits
--- @page script_unit
...
--- @return @script_unit matching name, or @nil
...
--- @p @battle_unit unit
--- @return @script_unit matching unit, or @nil
...
--- @desc Returns the @script_unit in this script_units collection that contains a @battle_unit of the supplied type. @nil is returned if no matching script_unit is found.
...
--- @desc Returns whether this script_units collection contains a @script_unit of the supplied type, from the <code>main_units</code> table.
--- @p string unit type
...
--- @return object closest foreign object from the supplied object - either a @battle_vector, a @battle_unit or a @script_unit, depending upon the container type.
