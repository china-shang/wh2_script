...
--- @loaded_in_battle
--- @loaded_in_frontend
---	@class timer_manager timer_manager Timer Manager
...
--- @desc It is rare for battle scripts to need to talk directly to the timer manager as the battle manager automatically creates a timer manager and provides a pass-through interface for the most-commonly-used timer manager functionality. See the @"battle_manager:Timer Manager" section of the @battle_manager documentation for more information.
...
--- @p [opt=100] number tick time, Model tick time in ms. Defaults to 100ms.
