...
function campaign_ui_manager:load_ui_overrides()
	...
	--	beastmen_panel
	-------------------------------
	ui_overrides.beastmen_panel = ui_override:new(
		"beastmen_panel",
		function()
			set_component_active_with_parent(false, core:get_ui_root(), "faction_buttons_docker", "button_beastmen_panel");
		end,
		function()
			set_component_active_with_parent(true, core:get_ui_root(), "faction_buttons_docker", "button_beastmen_panel");
		end
	);
