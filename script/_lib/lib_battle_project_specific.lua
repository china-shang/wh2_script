...
function display_shanty_text(shanty_number)
	...
	if effect.get_advice_history_string_seen("vampire_coast_battle_shanty_" .. shanty_number) and not effect.subtitles_enabled() then
	...
	effect.set_advice_history_string_seen("vampire_coast_battle_shanty_" .. shanty_number);
