...
if gb:get_army(ai_alliance, 3, "def_wave_1") then	
	-- if we've already found a race 1 then this is race 2, otherwise it's race 1
	if ga_ai_race_1_wave_1 then
		...
		ga_ai_race_1 = gb:get_army(ai_alliance, 3);
		ga_ai_race_1_wave_1 = gb:get_army(ai_alliance, 3, "def_wave_1");
		ga_ai_race_1_wave_2 = gb:get_army(ai_alliance, 3, "def_wave_2");
...
elseif gb:get_army(ai_alliance, 3, "hef_wave_1") then	
	...
	if ga_ai_race_1_wave_1 then
		...
		ga_ai_race_1 = gb:get_army(ai_alliance, 3);
		ga_ai_race_1_wave_1 = gb:get_army(ai_alliance, 3, "hef_wave_1");
		ga_ai_race_1_wave_2 = gb:get_army(ai_alliance, 3, "hef_wave_2");
...
elseif gb:get_army(ai_alliance, 3, "lzd_wave_1") then
	...
	if ga_ai_race_1_wave_1 then
		...
		ga_ai_race_1 = gb:get_army(ai_alliance, 3);
		ga_ai_race_1_wave_1 = gb:get_army(ai_alliance, 3, "lzd_wave_1");
		ga_ai_race_1_wave_2 = gb:get_army(ai_alliance, 3, "lzd_wave_2");
...
-- if we've yet to find race 2 then look for it in army 4
if not ga_ai_race_2_wave_1 then
	if gb:get_army(ai_alliance, 4, "def_wave_1") then
...
ga_ai_grey_seer_clan = gb:get_army(ai_alliance, "reinforcements");
