...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc09_tmb_khalida_qb_final_battle_01", "subtitle_with_frame", 5.5)	end, 3000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc09_tmb_khalida_qb_final_battle_02", "subtitle_with_frame", 6.5)	end, 11500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc09_tmb_khalida_qb_final_battle_03", "subtitle_with_frame", 6.5)	end, 23600);	
