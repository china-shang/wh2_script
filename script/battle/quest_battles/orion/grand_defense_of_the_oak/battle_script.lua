...
ga_ai_wef_ally_02 = gb:get_army(gb:get_player_alliance_num(), "wef_reinforcements");
ga_ai_bst_ally_01 = gb:get_army(gb:get_non_player_alliance_num(), "bst_first_wave");
ga_ai_bst_ally_02 = gb:get_army(gb:get_non_player_alliance_num(), "bst_khazrak");
ga_ai_bst_ally_03 = gb:get_army(gb:get_non_player_alliance_num(), "bst_malagor");
ga_ai_morghur = gb:get_army(gb:get_non_player_alliance_num(), "bst_morghur");
