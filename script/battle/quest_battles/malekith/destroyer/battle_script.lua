...
ga_ally_01 = gb:get_army(gb:get_player_alliance_num(), "player_ally_1");
...
ga_defender_01:message_on_rout_proportion("tyrion_army_dead", 1);
ga_defender_02:message_on_rout_proportion("teclis_army_dead", 1);
ga_defender_03:message_on_rout_proportion("reinforcements_dead", 1);
...
gb:set_objective_on_message("01_intro_cutscene_end", "wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_main_objective"); 
gb:set_objective_on_message("reinforcements", "wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_second_objective");
gb:set_objective_on_message("reinforcements", "wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_third_objective");

gb:complete_objective_on_message("tyrion_army_dead", "wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_main_objective", 10);
gb:complete_objective_on_message("teclis_army_dead", "wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_second_objective", 10);
gb:complete_objective_on_message("reinforcements_dead", "wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_third_objective", 10);
-------------------------------------------------------------------------------------------------
--------------------------------------------- HINTS ---------------------------------------------
-------------------------------------------------------------------------------------------------
