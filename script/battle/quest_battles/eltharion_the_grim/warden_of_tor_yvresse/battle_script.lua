...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_hef_Eltharion_final_battle_pt_01", "subtitle_with_frame", 11, true) end, 2000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_hef_Eltharion_final_battle_pt_02", "subtitle_with_frame", 8, true) end, 15000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_hef_Eltharion_final_battle_pt_03", "subtitle_with_frame", 9, true) end, 25000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_hef_Eltharion_final_battle_pt_04", "subtitle_with_frame", 16, true) end, 36000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_hef_Eltharion_final_battle_pt_05", "subtitle_with_frame", 17, true) end, 54000);	
