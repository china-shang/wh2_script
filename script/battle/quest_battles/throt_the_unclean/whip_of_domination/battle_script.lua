...
function battle_start_teleport_units()
	...
	ga_enemy_chaos_blockade.sunits:item(16).uc:teleport_to_location(v(165, -262), 270, 25);		--chaos spawn
	ga_enemy_chaos_blockade.sunits:item(17).uc:teleport_to_location(v(-176, -264), 90, 25);
	ga_enemy_chaos_blockade.sunits:item(18).uc:teleport_to_location(v(-354, -280), 180, 25);	--hounds
	ga_enemy_chaos_blockade.sunits:item(19).uc:teleport_to_location(v(370, -308), 180, 25);
end;
...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc16_Throt_Whip_of_Domination_pt_01", "subtitle_with_frame", 9, true) end, 2000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc16_Throt_Whip_of_Domination_pt_02", "subtitle_with_frame", 9, true) end, 12000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc16_Throt_Whip_of_Domination_pt_03", "subtitle_with_frame", 6, true) end, 22500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc16_Throt_Whip_of_Domination_pt_04", "subtitle_with_frame", 8, true) end, 34000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc16_Throt_Whip_of_Domination_pt_05", "subtitle_with_frame", 7, true) end, 57500);	
