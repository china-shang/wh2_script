...
ga_ai_bret_02 = gb:get_army(gb:get_non_player_alliance_num(1), "Second");
ga_ai_bret_03 = gb:get_army(gb:get_non_player_alliance_num(1), "Third");
ga_ai_bret_04 = gb:get_army(gb:get_non_player_alliance_num(1), "Fourth");
ga_ai_bret_05 = gb:get_army(gb:get_non_player_alliance_num(1), "Fifth");
