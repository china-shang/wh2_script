...
ga_enemy_army_morghur_fast_beasts:attack_on_message("01_intro_cutscene_end", 20000);
...
ga_enemy_army_morghur_patrol_pigs:attack_on_message("01_intro_cutscene_end", 20000);
