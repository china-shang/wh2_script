...
gb:queue_help_on_message("trigger_reinforce_1", "wh_dlc01_qb_chs_archaon_slayer_of_kings_stage_3_hint_reinforcements", 13000, 2000, 4000);
...
gb:message_on_time_offset("trigger_reinforce_1", 30000,"sorceror_dead");
gb:message_on_time_offset("trigger_reinforce_2", 60000,"sorceror_dead");
gb:message_on_time_offset("trigger_reinforce_3", 120000,"sorceror_dead");

ga_ai_02:deploy_at_random_intervals_on_message("trigger_reinforce_1", 1, 1, 60000, 61000, "sorceror_dead");
ga_ai_03:deploy_at_random_intervals_on_message("trigger_reinforce_2", 1, 1, 60000, 61000, "sorceror_dead");
ga_ai_04:deploy_at_random_intervals_on_message("trigger_reinforce_3", 1, 1, 60000, 61000, "sorceror_dead");
