...
ga_player_ally=gb:get_army(gb:get_player_alliance_num(), "reinf");
...
function end_deployment_phase()
	...
	cutscene_intro:action(function() bm:cindy_playback("script\\battle\\quest_battles\\_cutscene\\managers\\bet.CindySceneManager", true) end, 200);
