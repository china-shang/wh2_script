...
ga_defender_02 = gb:get_army(gb:get_player_alliance_num(), "player_ally_teclis_west");
ga_defender_03 = gb:get_army(gb:get_player_alliance_num(), "player_ally_teclis_east");
