...
-- Version A with enemy reinforcements
-- Attacker
...
wh2_main_sfx_04 = new_sfx("Play_wh2_dlc17_lzd_oxyotl_the_golden_blowpipe_of_ptoohee_pt_04a");
...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc17_lzd_oxyotl_the_golden_blowpipe_of_ptoohee_pt_04a", "subtitle_with_frame", 7, true) end, 33500);	
...
enemy_reinforcements = gb:get_army(gb:get_non_player_alliance_num(),"enemy_reinforcements");
...
--enemy_main receives casualties trigger enemy_reinforcements message
enemy_main:message_on_rout_proportion("enemy_reinforcements_casualties", 0.5);

--5 minute enemy_reinforcements countdown starts
gb:message_on_time_offset("enemy_reinforcements_countdown", 300000, "battle_started")

--enemy_reinforcements enter battlefield
enemy_reinforcements:reinforce_on_message("enemy_reinforcements_casualties", 10);
enemy_reinforcements:reinforce_on_message("enemy_reinforcements_countdown", 10);
enemy_reinforcements:release_on_message("enemy_reinforcements_casualties", 2000);
enemy_reinforcements:release_on_message("enemy_reinforcements_countdown", 2000);

--if port defenders rout block countdown, if 5 minute countdown ends block rout message
gb:block_message_on_message("enemy_reinforcements_countdown", "enemy_reinforcements_casualties", true);
gb:block_message_on_message("enemy_reinforcements_casualties", "enemy_reinforcements_countdown", true);
...
gb:queue_help_on_message("enemy_reinforcements_countdown", "wh2_dlc17_lzd_oxyotl_the_golden_blowpipe_of_ptoohee_hints_enemy_reinforcements");
gb:queue_help_on_message("enemy_reinforcements_casualties", "wh2_dlc17_lzd_oxyotl_the_golden_blowpipe_of_ptoohee_hints_enemy_reinforcements");
