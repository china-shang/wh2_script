...
ga_ai_greenskins_01 = gb:get_army(gb:get_non_player_alliance_num(), "skarsnik_army");
ga_ai_greenskins_02 = gb:get_army(gb:get_non_player_alliance_num(), "wurrzag_army");
ga_ai_greenskins_03 = gb:get_army(gb:get_non_player_alliance_num(), "azhag_army");
ga_ai_greenskins_04 = gb:get_army(gb:get_non_player_alliance_num(), "grimgor_army");
