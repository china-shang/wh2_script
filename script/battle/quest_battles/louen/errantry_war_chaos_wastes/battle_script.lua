...
ga_ai_ally_peasants = gb:get_army(gb:get_player_alliance_num(), "prophetess_army");
ga_ai_ally_errants = gb:get_army(gb:get_player_alliance_num(), "errantry_knights_army");

ga_ai_chaos_01 = gb:get_army(gb:get_non_player_alliance_num(), "archaon_army");
ga_ai_cannon = gb:get_army(gb:get_non_player_alliance_num(), "cannon");
ga_ai_chaos_02 = gb:get_army(gb:get_non_player_alliance_num(), "sigvald_army");
ga_ai_chaos_03 = gb:get_army(gb:get_non_player_alliance_num(), "kholek_army");
ga_ai_chaos_04 = gb:get_army(gb:get_non_player_alliance_num(), "lord_of_change_army");
