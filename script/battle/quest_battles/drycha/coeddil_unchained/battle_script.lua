...
-- Ambushes --
	...
	ga_enemy_army_cythral_hill_ambush_1.sunits:item(2).uc:teleport_to_location(v(-302.77, 228.64), 150, 40);
	...
	ga_enemy_army_cythral_hill_ambush_2.sunits:item(2).uc:teleport_to_location(v(177.83, 266.42), 250, 40);
...
cutscene_modryn_reinforcements:set_do_not_end(false);
...
cutscene_anmyr_reinforcements:set_do_not_end(false);
...
cutscene_coeddil_unchained:set_do_not_end(false);
