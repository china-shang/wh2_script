...
ga_ai_02_vmp_side_attack_1:message_on_rout_proportion("vamp_army_dead", 1);
ga_ai_02_vmp_side_attack_2:message_on_rout_proportion("vamp_army_dead", 1);
ga_ai_02_vmp_side_attack_3:message_on_rout_proportion("vamp_army_dead", 1);
ga_ai_02_vmp_defenders:message_on_rout_proportion("vamp_army_dead", 1);
