...
ga_ai_02 = gb:get_army(gb:get_non_player_alliance_num(), 1,"wave_01_inf");
ga_ai_03 = gb:get_army(gb:get_non_player_alliance_num(), 1,"wave_02_inf");

ga_ai_04 = gb:get_army(gb:get_non_player_alliance_num(), 2,"wave_01_cav");
ga_ai_05 = gb:get_army(gb:get_non_player_alliance_num(), 2,"wave_02_cav");

ga_ai_06 = gb:get_army(gb:get_non_player_alliance_num(), 3,"wave_01_light_cav");
ga_ai_07 = gb:get_army(gb:get_non_player_alliance_num(), 3,"wave_02_light_cav");
...
ga_ai_03.army:suppress_reinforcement_adc();
ga_ai_04.army:suppress_reinforcement_adc();
ga_ai_05.army:suppress_reinforcement_adc();
ga_ai_06.army:suppress_reinforcement_adc();
ga_ai_07.army:suppress_reinforcement_adc();
