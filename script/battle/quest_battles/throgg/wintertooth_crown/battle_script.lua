...
ga_ai_dwarfs_01 = gb:get_army(gb:get_non_player_alliance_num(1), 1, "First");
ga_ai_dwarfs_02 = gb:get_army(gb:get_non_player_alliance_num(1), 2, "Second");
ga_ai_dwarfs_03 = gb:get_army(gb:get_non_player_alliance_num(1), 3, "Third");
ga_ai_dwarfs_04 = gb:get_army(gb:get_non_player_alliance_num(1), 2, "Fourth");
ga_ai_dwarfs_05 = gb:get_army(gb:get_non_player_alliance_num(1), 2, "Fifth");

ga_ai_dwarfs_02.army:suppress_reinforcement_adc(); 
