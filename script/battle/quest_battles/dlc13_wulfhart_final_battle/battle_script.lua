...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc13_emp_markus_wulfhart_final_battle_pt_01", "subtitle_with_frame", 13) end, 3500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc13_emp_markus_wulfhart_final_battle_pt_02", "subtitle_with_frame", 15) end, 17500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc13_emp_markus_wulfhart_final_battle_pt_03", "subtitle_with_frame", 10) end, 34500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc13_emp_markus_wulfhart_final_battle_pt_04", "subtitle_with_frame", 8) end, 47000);	
