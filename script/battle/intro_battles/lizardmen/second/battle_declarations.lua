...
if sunits_player_cav:count() == 2 then
	sunits_player_cav:item(1).uc:teleport_to_location(v(202.3, -23.4), r_to_d(-1.64), 23.1);
	sunits_player_cav:item(2).uc:teleport_to_location(v(200.7, 1.64), r_to_d(-1.64), 23.1);
else
