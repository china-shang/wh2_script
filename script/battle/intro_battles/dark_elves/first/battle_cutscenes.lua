...
cutscene_enemy_reinforcements_length = 22000;

cutscene_enemy_reinforcements = cutscene:new(
	"cutscene_enemy_reinforcements", 			-- unique string name for cutscene
	sunits_player_start, 						-- unitcontroller over player's army
	cutscene_enemy_reinforcements_length,		-- duration of cutscene in ms
...
cutscene_enemy_reinforcements:set_do_not_end(true);
...
cutscene_player_missile_reinforcements_length = 14000;
...
cutscene_player_missile_reinforcements = cutscene:new(
	...
	cutscene_player_missile_reinforcements_length,			-- duration of cutscene in ms
	nil														-- what to call when cutscene is finished
);
...
cutscene_player_missile_reinforcements:set_do_not_end(true);
...
cutscene_player_cavalry_reinforcements_length = 12500;
...
cutscene_player_cavalry_reinforcements = cutscene:new(
	...
	sunits_player_start, 									-- unitcontroller over player's army
	cutscene_player_cavalry_reinforcements_length,			-- duration of cutscene in ms
	nil														-- what to call when cutscene is finished
);
...
cutscene_player_cavalry_reinforcements:set_do_not_end(true);
