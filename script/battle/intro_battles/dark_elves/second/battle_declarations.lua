...
if sunits_player_cav:count() == 2 then
	sunits_player_cav:item(1).uc:teleport_to_location(v(-172.8, 41.9), r_to_d(1.53), 26.7);
	sunits_player_cav:item(2).uc:teleport_to_location(v(-171.8, 13.2), r_to_d(1.53), 26.7);
else
