...
core:add_listener(
	...
	function(context)
		...
		elseif not (character:has_region() and character:region():get_active_edict_key() == "wh2_dlc11_edict_cst_share_the_spoils") or not character:has_skill("wh2_dlc11_skill_cst_loyal_lord") then
