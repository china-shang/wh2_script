local ui_feature_highlights = {
	...
	["wh_dlc07_event_feed_scripted_intro_bretonnia"] = {
		{path = {"layout", "resources_bar", "right spacer_bretonnia", "dy_peasants"}},
		{path = {"layout", "faction_buttons_docker", "button_spawn_unique_agent"}}
	},
	...
	["wh2_dlc10_event_feed_scripted_intro_hellebron"] = {
		{path = {"layout", "resources_bar", "topbar_list_parent", "death_night_holder"}},
		{path = {"layout", "faction_buttons_docker", "button_group_management", "sword_of_khaine", "button_sword_of_khaine"}}
	},
	["wh2_dlc10_event_feed_scripted_intro_alarielle"] = {
		{path = {"layout", "resources_bar", "topbar_list_parent", "alarielle_holder", "icon_effect"}},
		{path = {"layout", "faction_buttons_docker", "button_group_management", "sword_of_khaine", "button_sword_of_khaine"}}
	},
	["wh2_dlc10_event_feed_scripted_intro_alith_anar"] = {
		{path = {"layout", "resources_bar", "topbar_list_parent", "alith_anar_holder"}},
		{path = {"layout", "faction_buttons_docker", "button_group_management", "sword_of_khaine", "button_sword_of_khaine"}}
	},
	
	-- DLC11 - Vampire Coast
	["wh2_dlc11_event_feed_scripted_intro_harkon"] = {
		{path = {"layout", "resources_bar", "infamy_holder"}}
	},
	...
	["wh2_dlc12_event_feed_scripted_intro_ikit"] = {
		{path = {"layout", "faction_buttons_docker", "button_group_management", "button_ikit_workshop"}},
		{path = {"layout", "resources_bar", "left_spacer_WH2_skin", "ikit_resources"}}
	},
	["wh2_dlc12_event_feed_scripted_intro_tehenhauin"] = {
		{path = {"layout", "resources_bar", "topbar_list_parent", "sotek_plaque_holder", "plaque_1"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "sotek_plaque_holder", "plaque_2"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "sotek_plaque_holder", "plaque_3"}},
		{path = {"layout", "faction_buttons_docker", "button_group_management", "button_sotek_sacrifices"}}
	},

	-- DLC14 - Shadow & Blade
	["wh2_dlc14_event_feed_scripted_intro_snikch"] = {
		{path = {"layout", "faction_buttons_docker", "button_group_management", "button_shadowy_dealings"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "warpstone_dust_holder"}}
	},

	--DLC15 - Warden & Paunch
	["wh2_dlc15_event_feed_scripted_intro_eltharion"] = {
		{path = {"layout", "faction_buttons_docker", "button_group_management", "button_athel_tamarha_dungeon"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "defence_of_yvresse_holder", "defence_level"}}
	},
	...
	["wh2_dlc16_event_feed_scripted_intro_throt"] = {
		...
		--{path = {"layout", "faction_buttons_docker", "button_group_management", "button_flesh_lab"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "growth_var_bar_holder", "flesh_lab_top_bar","growth_vat_bar_holder","growth_vat_bar"}}
	},
	["wh2_dlc16_event_feed_scripted_intro_sisters"] = {
		{path = {"layout", "resources_bar", "topbar_list_parent", "forge_of_daith_holder", "forge_of_daith", "forge_button_holder", "forge_button"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "forge_of_daith_holder", "forge_of_daith", "timer", "timer"}}
	},

	--DLC17 - Silence and Fury
	["wh2_dlc17_event_feed_scripted_intro_oxyotl"] = {
		{path = {"layout", "resources_bar", "topbar_list_parent", "oxyotl_silent_sanctum_holder", "oxyotl_silent_sanctum", "top_bar_holder", "button_holder"}},
		{path = {"layout", "resources_bar", "topbar_list_parent", "oxyotl_silent_sanctum_holder", "oxyotl_silent_sanctum", "top_bar_holder", "button_holder", "sanctum_button"}},
		{path = {"layout", "faction_buttons_docker", "button_group_management", "button_threat_map"}}
	}
};
