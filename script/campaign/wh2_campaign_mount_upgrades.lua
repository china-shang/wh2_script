...
function add_mount_upgrade_listeners()
	...
	core:add_listener(
		...
		function(context)
			...
			return faction:name() == "wh2_main_lzd_tlaqua" or faction:name() == "wh2_dlc15_hef_imrik" or culture == "wh2_dlc11_cst_vampire_coast" or culture == "wh_main_brt_bretonnia";
		end,
		function(context)
	...
	if cm:is_new_game() then
		...
		for i = 0, faction_list:num_items() - 1 do
			...
			if current_faction:name() == "wh2_main_lzd_tlaqua" or current_faction:name() == "wh2_dlc15_hef_imrik" or current_faction_culture == "wh2_dlc11_cst_vampire_coast" or current_faction_culture == "wh_main_brt_bretonnia" then
