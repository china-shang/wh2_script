...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc12.camp.me.flyby.skv.ikit.001";
	advice_to_play[2] = "dlc12.camp.me.flyby.skv.ikit.002";
	advice_to_play[3] = "dlc12.camp.me.flyby.skv.ikit.003";
	advice_to_play[4] = "dlc12.camp.me.flyby.skv.ikit.004";
	advice_to_play[5] = "dlc12.camp.me.flyby.skv.ikit.005";
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_skv_clan_skyre/scenes/wh2_main_skv_clan_skyre.CindyScene", 0, 6);
		end,
		0
	);
