...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc09.camp.arkhan.intro.001";
	advice_to_play[2] = "dlc09.camp.arkhan.intro.002";
	advice_to_play[3] = "dlc09.camp.arkhan.intro.003";
	advice_to_play[4] = "dlc09.camp.arkhan.intro.004";
	advice_to_play[5] = "dlc09.camp.arkhan.intro.005";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		63.5,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc09_tmb_followers_of_nagash/scenes/followers_of_nagash_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
