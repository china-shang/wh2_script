...
function faction_new_sp_game_startup()
	...
	cm:make_region_seen_in_shroud("wh2_main_hef_yvresse", "wh_main_blightwater_misty_mountain");
	cm:make_region_seen_in_shroud("wh2_main_hef_yvresse", "wh_main_blightwater_kradtommen");
	cm:make_region_seen_in_shroud("wh2_main_hef_yvresse", "wh_main_desolation_of_nagash_spitepeak");
	cm:make_region_seen_in_shroud("wh2_main_hef_yvresse", "wh_main_blightwater_deff_gorge");
	cm:make_region_seen_in_shroud("wh2_main_hef_yvresse", "wh_main_eastern_badlands_dringorackaz");
	cm:make_region_seen_in_shroud("wh2_main_hef_yvresse", "wh_main_eastern_badlands_karak_azgal");
...
function faction_each_sp_game_startup()
	...
	if cm:turn_number()< 3 then
		core:add_listener(
			"FactionTurnStartYvresseReminder",
			"FactionTurnStart",
			function(context)
				return context:faction():name() == local_faction
			end,
			function()
				core:trigger_event("YvresseReminder");
			end,
			false
		);
	end
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc15.camp.eltharion.intro.001";
	advice_to_play[2] = "wh2_dlc15.camp.eltharion.intro.002";
	advice_to_play[3] = "wh2_dlc15.camp.eltharion.intro.003";
	advice_to_play[4] = "wh2_dlc15.camp.eltharion.intro.004";
	advice_to_play[5] = "wh2_dlc15.camp.eltharion.intro.005";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		73.5,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_hef_yvresse/scenes/yvresse_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
