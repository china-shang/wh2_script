...
-----------------------------------------------------------------------------------
--
--	HIGH ELVES (TYRION) PRELUDE SCRIPT
--
-----------------------------------------------------------------------------------
-----------------------------------------------------------------------------------
...
if not cm:is_multiplayer() then
	...
	chapter_two_mission = chapter_mission:new(2, local_faction, "wh2_main_objective_tyrion_02", "war.camp.advice.chapter_two.001");
	chapter_three_mission = chapter_mission:new(3, local_faction, "wh2_main_objective_tyrion_03", "war.camp.advice.chapter_three.001");
	chapter_four_mission = chapter_mission:new(4, local_faction, "wh2_main_objective_tyrion_04", "war.camp.advice.chapter_four.001");
	chapter_five_mission = chapter_mission:new(5, local_faction, "wh2_main_objective_tyrion_05", "war.camp.advice.chapter_five.001");
end;
