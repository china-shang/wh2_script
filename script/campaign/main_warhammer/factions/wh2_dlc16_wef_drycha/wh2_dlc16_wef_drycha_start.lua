...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc16.camp.drycha.intro.001";
	advice_to_play[2] = "wh2_dlc16.camp.drycha.intro.002";
	advice_to_play[3] = "wh2_dlc16.camp.drycha.intro.003";
	advice_to_play[4] = "wh2_dlc16.camp.drycha.intro.004";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		85.0,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc16_wef_drycha/scenes/drycha_01.CindyScene", 0, 5);
		end,
		0
	);
