...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2.camp.queek.intro.001";
	advice_to_play[2] = "wh2.camp.queek.intro.002";
	advice_to_play[3] = "wh2.camp.queek.intro.003";
	advice_to_play[4] = "wh2.camp.queek.intro.004";
	advice_to_play[5] = "wh2.camp.queek.intro.005";
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_skv_clan_mors/scenes/clan_mors_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
