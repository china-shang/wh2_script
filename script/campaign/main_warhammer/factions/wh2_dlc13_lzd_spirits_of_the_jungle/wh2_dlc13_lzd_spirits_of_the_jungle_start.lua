...
--224.51564 432.987152 15.301414 0.247867 14.121611
cam_start_x = 224.51564;
cam_start_y = 432.987152;
cam_start_d = 15.301414;
cam_start_b = 0;
cam_start_h = 14.121611;
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc13_camp_me_flyby_nakai_001";
	advice_to_play[2] = "wh2_dlc13_camp_me_flyby_nakai_002";
	advice_to_play[3] = "wh2_dlc13_camp_me_flyby_nakai_003";
	advice_to_play[4] = "wh2_dlc13_camp_me_flyby_nakai_004";
	advice_to_play[5] = "wh2_dlc13_camp_me_flyby_nakai_005";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		76,													-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc13_lzd_spirits_of_the_jungle/scenes/wh2_dlc13_lzd_spirits_of_the_jungle.CindyScene", 0, 10);
		end,
		0
	);
