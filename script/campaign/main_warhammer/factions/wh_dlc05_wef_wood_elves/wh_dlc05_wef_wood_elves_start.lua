...
-- intro skip camera
cam_skip_x = 322.9;					-- camera target x position
cam_skip_y = 254.3;					-- camera target y position
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc05.camp.Orion.intro.001"
	advice_to_play[2] = "dlc05.camp.Orion.intro.002"
	advice_to_play[3] = "dlc05.camp.Orion.intro.003"
	advice_to_play[4] = "dlc05.camp.Orion.intro.004"
	advice_to_play[5] = "dlc05.camp.Orion.intro.005"
	advice_to_play[6] = "dlc05.camp.Orion.intro.006"
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		79,													-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_dlc05_wef_wood_elves/scenes/we_orion_mc_intro.CindyScene", 0, 5);
		end,
		0
	);
