...
-- intro skip camera
cam_skip_x = 254.70;				-- camera target x position
cam_skip_y = 374.75;				-- camera target y position
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc07.camp.flyby.brt.louen.001"
	advice_to_play[2] = "dlc07.camp.flyby.brt.louen.002"
	advice_to_play[3] = "dlc07.camp.flyby.brt.louen.003"
	advice_to_play[4] = "dlc07.camp.flyby.brt.louen.004"
	advice_to_play[5] = "dlc07.camp.flyby.brt.louen.005"
	advice_to_play[6] = "dlc07.camp.flyby.brt.louen.006"
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_main_brt_bretonnia/scenes/bretonnia_main_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
