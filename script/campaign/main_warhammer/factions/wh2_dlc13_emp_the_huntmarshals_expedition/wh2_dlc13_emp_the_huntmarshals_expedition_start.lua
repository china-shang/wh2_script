...
--(70.01178 145.799118 16.665512 0.0 10.308443)
cam_start_x = 70.01178;
cam_start_y = 145.799118;
cam_start_d = 16.665512;
cam_start_b = 0;
cam_start_h = 10.308443;
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc13_camp_me_flyby_markus_wulfhart_001";
	advice_to_play[2] = "wh2_dlc13_camp_me_flyby_markus_wulfhart_002";
	advice_to_play[3] = "wh2_dlc13_camp_me_flyby_markus_wulfhart_003";
	advice_to_play[4] = "wh2_dlc13_camp_me_flyby_markus_wulfhart_004";
	advice_to_play[5] = "wh2_dlc13_camp_me_flyby_markus_wulfhart_005";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		70,													-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc13_emp_the_huntmarshals_expedition/scenes/wh2_dlc13_emp_the_huntmarshals_expedition.CindyScene", 0, 10);
		end,
		0
	);
