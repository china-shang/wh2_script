...
-----------------------------------------------------------------------------------
--
--	IRONBROWS EXPEDITION (THOREK IRONBROW) PRELUDE SCRIPT
--
-----------------------------------------------------------------------------------
-----------------------------------------------------------------------------------
...
if not cm:is_multiplayer() then
	chapter_one_mission = chapter_mission:new(1, local_faction, "wh2_dlc17_objective_thorek_01");
	chapter_two_mission = chapter_mission:new(2, local_faction, "wh2_dlc17_objective_thorek_02", "war.camp.advice.chapter_two.001");
	chapter_three_mission = chapter_mission:new(3, local_faction, "wh2_dlc17_objective_thorek_03", "war.camp.advice.chapter_three.001");
	chapter_four_mission = chapter_mission:new(4, local_faction, "wh2_dlc17_objective_thorek_04", "war.camp.advice.chapter_four.001");
	chapter_five_mission = chapter_mission:new(5, local_faction, "wh2_dlc17_objective_thorek_05", "war.camp.advice.chapter_five.001");
end;
...
--[[
if not cm:is_multiplayer() then
	chapter_one_mission = chapter_mission:new(1, local_faction, "wh_dlc06_objective_belegar_01");
	chapter_two_mission = chapter_mission:new(2, local_faction, "wh_dlc06_objective_belegar_02", "war.camp.advice.chapter_two.001");
	chapter_three_mission = chapter_mission:new(3, local_faction, "wh_dlc06_objective_belegar_03", "war.camp.advice.chapter_three.001");
	chapter_four_mission = chapter_mission:new(4, local_faction, "wh_dlc06_objective_belegar_04", "war.camp.advice.chapter_four.001");
	chapter_five_mission = chapter_mission:new(5, local_faction, "wh_dlc06_objective_belegar_05", "war.camp.advice.chapter_five.001");
end;
--]]
