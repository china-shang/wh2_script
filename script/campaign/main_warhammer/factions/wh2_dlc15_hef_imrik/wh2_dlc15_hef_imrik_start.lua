...
function faction_new_sp_game_startup()
	...
	cm:make_region_seen_in_shroud("wh2_dlc15_hef_imrik", "wh2_main_the_wolf_lands_crookback_mountain");
	cm:make_region_seen_in_shroud("wh2_dlc15_hef_imrik", "wh2_main_the_wolf_lands_mount_greyhag");
	cm:make_region_seen_in_shroud("wh2_dlc15_hef_imrik", "wh2_main_the_wolf_lands_mount_silverspear");
	cm:make_region_seen_in_shroud("wh2_dlc15_hef_imrik", "wh_main_desolation_of_nagash_karak_azul");
	cm:make_region_seen_in_shroud("wh2_dlc15_hef_imrik", "wh_main_desolation_of_nagash_black_iron_mine");
end;
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc15.camp.imrik.intro.001";
	advice_to_play[2] = "wh2_dlc15.camp.imrik.intro.002";
	advice_to_play[3] = "wh2_dlc15.camp.imrik.intro.003";
	advice_to_play[4] = "wh2_dlc15.camp.imrik.intro.004";
	advice_to_play[5] = "wh2_dlc15.camp.imrik.intro.005";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		76.0,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc15_hef_imrik/scenes/imrik_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
