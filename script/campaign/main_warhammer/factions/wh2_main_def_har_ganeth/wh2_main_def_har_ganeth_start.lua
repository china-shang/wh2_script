...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc10.camp.hellebron.intro.001";
	advice_to_play[2] = "wh2_dlc10.camp.hellebron.intro.002";
	advice_to_play[3] = "wh2_dlc10.camp.hellebron.intro.003";
	advice_to_play[4] = "wh2_dlc10.camp.hellebron.intro.004";
	advice_to_play[5] = "wh2_dlc10.camp.hellebron.intro.005";
	...
	cutscene_intro:action(
		function()
			...
			--cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_def_har_ganeth/scenes/har_ganeth_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
