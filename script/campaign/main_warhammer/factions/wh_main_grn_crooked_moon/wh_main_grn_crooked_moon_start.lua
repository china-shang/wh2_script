...
function cutscene_intro_play()
	...
	-- From your redoubt in Karak Azgaraz, you have plotted your return to the Eight Peaks, stolen by filthy, perfidious Greenskin rebels.
	advice_to_play[1] = "dlc06.camp.Skarsnik.intro.001";
	-- The road back to the Peaks will not be simple. You must head east, into Empire territory. Humans have no love for Greenskins, so you must fight tooth and nail to overcome them.
	advice_to_play[2] = "dlc06.camp.Skarsnik.intro.002";
	-- Past the Empire, both the Border Princes and the Dwarfs will attempt to hamper you further, but you must destroy all in your path.
	advice_to_play[3] = "dlc06.camp.Skarsnik.intro.003";
	-- To the south, in Karak Izor, the foul Belegar Ironhammer has aspirations to reclaim his ancestral home. The Eight Peaks are yours, Skarsnik - do not relent until the threat is dealt with and they are back under your control.
	advice_to_play[4] = "dlc06.camp.Skarsnik.intro.004";
	...
	advice_to_play[5] = "dlc06.camp.Skarsnik.intro.005";
	-- You have overthrown rebellions before, and will do so again. All those who oppose you will face your rage, and then the hunger of Gobbla, of course. Destroy and devour all those who stand against you!
	advice_to_play[6] = "dlc06.camp.Skarsnik.intro.006";
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(318.2, 311.1, 10.0, 0.0, 10.0);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_main_grn_crooked_moon/scenes/skarsnik_main_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
