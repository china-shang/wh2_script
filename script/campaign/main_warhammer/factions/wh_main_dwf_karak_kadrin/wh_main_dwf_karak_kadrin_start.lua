...
cam_start_x = 478.08;			-- camera target x position
cam_start_y = 364.83;			-- camera target y position
cam_start_d = 31.28;			-- camera distance
cam_start_b = 0;				-- camera heading
cam_start_h = 10;				-- camera height

-- intro skip camera
cam_skip_x = 480.6;				-- camera target x position
cam_skip_y = 350.8;				-- camera target y position
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_main.camp.ungrim.intro.001";
	advice_to_play[2] = "wh2_main.camp.ungrim.intro.002";
	advice_to_play[3] = "wh2_main.camp.ungrim.intro.003";
	advice_to_play[4] = "wh2_main.camp.ungrim.intro.004";
	advice_to_play[5] = "wh2_main.camp.ungrim.intro.005";

	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		58,													-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_main_dwf_karak_kadrin/scenes/karak_kadrin_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
