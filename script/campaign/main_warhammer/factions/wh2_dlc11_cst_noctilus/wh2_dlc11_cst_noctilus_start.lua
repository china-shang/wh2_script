...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc11.camp.noctilus.intro.001"
	advice_to_play[2] = "wh2_dlc11.camp.noctilus.intro.002"
	advice_to_play[3] = "wh2_dlc11.camp.noctilus.intro.003"
	advice_to_play[4] = "wh2_dlc11.camp.noctilus.intro.004"
	advice_to_play[5] = "wh2_dlc11.camp.noctilus.intro.005"
	advice_to_play[6] = "wh2_dlc11.camp.noctilus.intro.006"
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		93.5,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc11_cst_noctilus/scenes/noctilus_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
