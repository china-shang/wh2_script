...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc14.camp.flyby.malus_darkblade.intro.001";
	advice_to_play[2] = "wh2_dlc14.camp.flyby.malus_darkblade.intro.002";
	advice_to_play[3] = "wh2_dlc14.camp.flyby.malus_darkblade.intro.003";
	advice_to_play[4] = "wh2_dlc14.camp.flyby.malus_darkblade.intro.004";
	advice_to_play[5] = "wh2_dlc14.camp.flyby.malus_darkblade.intro.005";
	...
	cutscene_intro:action(
		function()
			...
			--cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_def_hag_graef/scenes/dlc14_flyby_me_malus.CindyScene", 0, 10);
		end,
		0
	);
