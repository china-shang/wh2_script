...
cam_start_x = 214.51564;
cam_start_y = 417.987152;
...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_twa03.camp.me.flyby.rakarth.001";
	advice_to_play[2] = "wh2_twa03.camp.me.flyby.rakarth.002";
	advice_to_play[3] = "wh2_twa03.camp.me.flyby.rakarth.003";
	advice_to_play[4] = "wh2_twa03.camp.me.flyby.rakarth.004";
	advice_to_play[5] = "wh2_twa03.camp.me.flyby.rakarth.005";
	advice_to_play[6] = "wh2_twa03.camp.me.flyby.rakarth.006";
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_twa03_def_rakarth/scenes/rakarth_flyby.CindyScene", 0, 5);
		end,
		0
	);
