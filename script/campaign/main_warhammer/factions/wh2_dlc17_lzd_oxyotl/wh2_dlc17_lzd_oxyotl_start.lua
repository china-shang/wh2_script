...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc17.camp.oxyotl.intro.001";
	advice_to_play[2] = "wh2_dlc17.camp.oxyotl.intro.002";
	advice_to_play[3] = "wh2_dlc17.camp.oxyotl.intro.003";
	advice_to_play[4] = "wh2_dlc17.camp.oxyotl.intro.004";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		62,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc17_lzd_oxyotl/scenes/mortal_empires_oxyotl_flyby_01.CindyScene", 0, 5);
		end,
		0
	);
