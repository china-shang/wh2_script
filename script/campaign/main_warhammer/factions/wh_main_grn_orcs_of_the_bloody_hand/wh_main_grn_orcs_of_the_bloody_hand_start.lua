...
function cutscene_intro_play()
	...
	-- The Green Gods have led you to Ekrund, Lord Wurrzag! What do they whisper now? Are the Badlands ready for the taking?
	advice_to_play[1] = "dlc06.camp.Wurrzag.intro.001";
	-- The nearby area is teeming with tribes of inferior Greenskins; to the east, the Teef Snatchaz and Red Fangs gather, eager to exploit you and regain lost lands. Yet you are chosen by the gods - they will see that you prevail.
	advice_to_play[2] = "dlc06.camp.Wurrzag.intro.002";
	-- Demonstrate your strength to these weaklings, and tribes of lesser Orcs will flock to your banner, freeing you to pursue your twisted prophecies. The stunted Dwarfs that dwell in the mountains around you should provide plentiful quarry.
	advice_to_play[3] = "dlc06.camp.Wurrzag.intro.003";
	-- There are many who will not listen to your words, who call you misguided or mad. They will be brought to heel - you have foreseen it!
	advice_to_play[4] = "dlc06.camp.Wurrzag.intro.004";
	-- You are the Great Green Prophet, Wurrzag. You have been promised greatness by the gods - now go and claim it!
	advice_to_play[5] = "dlc06.camp.Wurrzag.intro.005";
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(400.4, 198.8, 10.0, 0.0, 10.0);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_main_grn_orcs_of_the_bloody_hand/scenes/wurrzag_main_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
