...
-----------------------------------------------------------------------------------
--
--	ORCS OF THE BLOODY HAND (WURRZAG) PRELUDE SCRIPT
--
-----------------------------------------------------------------------------------
-----------------------------------------------------------------------------------
...
if not cm:is_multiplayer() then
	chapter_one_mission = chapter_mission:new(1, local_faction, "wh_dlc06_objective_wurrzag_01");
	chapter_two_mission = chapter_mission:new(2, local_faction, "wh_dlc06_objective_wurrzag_02", "war.camp.advice.chapter_two.001");
	chapter_three_mission = chapter_mission:new(3, local_faction, "wh_dlc06_objective_wurrzag_03", "war.camp.advice.chapter_three.001");
	chapter_four_mission = chapter_mission:new(4, local_faction, "wh_dlc06_objective_wurrzag_04", "war.camp.advice.chapter_four.001");
	chapter_five_mission = chapter_mission:new(5, local_faction, "wh_dlc06_objective_wurrzag_05", "war.camp.advice.chapter_five.001");
	chapter_six_mission = chapter_mission:new(6, local_faction, "wh_dlc06_objective_wurrzag_06", "war.camp.advice.chapter_six.001");
end;
