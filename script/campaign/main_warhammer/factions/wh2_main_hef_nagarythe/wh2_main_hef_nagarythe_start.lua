...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc10.camp.alith_anar.intro.001";
	advice_to_play[2] = "wh2_dlc10.camp.alith_anar.intro.002";
	advice_to_play[3] = "wh2_dlc10.camp.alith_anar.intro.003";
	advice_to_play[4] = "wh2_dlc10.camp.alith_anar.intro.004";
	advice_to_play[5] = "wh2_dlc10.camp.alith_anar.intro.005";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		68.0,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			--cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_hef_nagarythe/scenes/nagarythe_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
