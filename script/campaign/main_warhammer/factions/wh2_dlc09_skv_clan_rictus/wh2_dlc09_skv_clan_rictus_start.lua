...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc09.camp.tretch.intro.001";
	advice_to_play[2] = "dlc09.camp.tretch.intro.002";
	advice_to_play[3] = "dlc09.camp.tretch.intro.003";
	advice_to_play[4] = "dlc09.camp.tretch.intro.004";
	advice_to_play[5] = "dlc09.camp.tretch.intro.005";
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_dlc09_skv_clan_rictus/scenes/clan_rictus_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
