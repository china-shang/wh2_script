...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc08.camp.flyby.nor.wulfrik.001"
	advice_to_play[2] = "dlc08.camp.flyby.nor.wulfrik.002"
	advice_to_play[3] = "dlc08.camp.flyby.nor.wulfrik.003"
	advice_to_play[4] = "dlc08.camp.flyby.nor.wulfrik.004"
	advice_to_play[5] = "dlc08.camp.flyby.nor.wulfrik.005"
	advice_to_play[6] = "dlc08.camp.flyby.nor.wulfrik.006"
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_dlc08_nor_norsca/scenes/norsca_campaign_flyby.CindyScene", 0, 5);
		end,
		0
	);
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[1]); -- Lasts 16 seconds
		end,
		0.5
	);
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[2]); -- Lasts 15 seconds
		end,
		17
	);
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[3]); -- Lasts 16 seconds
		end,
		33
	);
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[4]); -- Lasts 18 seconds
		end,
		51
	);
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[5]); -- Lasts 16 seconds
		end,
		72
	);
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[6]); -- Lasts 17 seconds
		end,
		90
	);
