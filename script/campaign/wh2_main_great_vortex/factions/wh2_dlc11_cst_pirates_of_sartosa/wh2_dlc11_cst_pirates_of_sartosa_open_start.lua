...
do
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- The Pirates of Sartosa have spent too long hassling small fry, the time has come to take on much bigger and valuable targets! Our first target is Yvresse, the Asur are sure to have a full treasury just begging to be looted!
		"wh2_dlc11.camp.vortex.AranessaSaltspite.early_game.001",
		nil, 
		"wh2_dlc11_cst_aranessa_early_game_capture_settlement",
		"SYMBOLS",
		shrine_of_loec_region_str,
		yvresse_faction_str,
		{
			"money 1000",
	...
	start_early_game_capture_province_mission_listener(
		-- The High Elves put up disappointingly little resistance; I barely got to use Manann’s gifts to me. The dead fight for me at the Sea God’s command, its time I used this boon to its fullest and push forward in my conquest against the Asur.
		"wh2_dlc11.camp.vortex.AranessaSaltspite.early_game.003",
		nil,
		"wh2_dlc11_cst_aranessa_early_game_capture_province",
		"SYMBOLS",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_enact_commandment",
		"SYMBOLS",
		{
			"money 500"
		}
	...
	start_early_game_eliminate_faction_mission_listener(
		nil,
		nil,
		"wh2_dlc11_cst_aranessa_early_game_eliminate_faction",
		"SYMBOLS",
		yvresse_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_upgrade_settlement_part_two",
		"SYMBOLS",
		sartosa_region_str,
		{
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_hero_building_mission",
		"SYMBOLS",
		{	
...
--temp buildings until agent recruitment has been tied to a particular chain
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_hero_recruitment_mission",
		"SYMBOLS",
		{
			"money 500",
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_hero_action_mission",
		"SYMBOLS",
		{
			"money 500",
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_raise_army_mission",
		"SYMBOLS",
		{
			"money 500",
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_non_aggression_pact", 
		"SYMBOLS",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_trade_agreement",
		"SYMBOLS",
		"wh2_dlc09_tmb_khemri",
		3,
		12,
	...
	start_early_game_cst_pirate_cove_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_pirate_cove_mission",
		"SYMBOLS",
		{		
	...
	start_early_game_cst_growth_point_ship_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_ship_building",
		"SYMBOLS",
		pirates_of_sartosa_faction_str,
		{
			"wh2_dlc11_vampirecoast_ship_captains_cabin_3"
		},
		{
	...
	start_early_game_cst_loyalty_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_aranessa_early_game_loyalty_mission",
		"SYMBOLS",
		pirates_of_sartosa_faction_str,
		{
			"money 1000",
	...
	start_early_game_cst_treasure_hunting_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_treasure_map_starting_treasure_aranessa"
	);
	...
	start_early_game_cst_search_for_the_vengeance_mission_listener(
		...
		"wh2_main_vor_sea_eastern_straits_of_the_great_ocean"
	);
end;