...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.000";
	advice_to_play[2] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.001";
	advice_to_play[3] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.002";
	advice_to_play[4] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.003";
	advice_to_play[5] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.004";
	advice_to_play[6] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.005";
	advice_to_play[7] = "wh2_dlc11.camp.vortex.Aranessa_Saltspite.intro.006";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		68.5,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc11_cst_pirates_of_sartosa/scenes/pirates_of_sartosa_flyby01.CindyScene", 0, 5);
		end,
		0
	);
...
if not cm:is_multiplayer() then
	...
	chapter_one_mission = chapter_mission:new(1, local_faction, "wh2_dlc11_objective_cst_01");
	chapter_two_mission = chapter_mission:new(2, local_faction, "wh2_dlc11_objective_cst_02");
	chapter_three_mission = chapter_mission:new(3, local_faction, "wh2_dlc11_objective_cst_03");
	chapter_four_mission = chapter_mission:new(4, local_faction, "wh2_dlc11_objective_cst_04");
end;