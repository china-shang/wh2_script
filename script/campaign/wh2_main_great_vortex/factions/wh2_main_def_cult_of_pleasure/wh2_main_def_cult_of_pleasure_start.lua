...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2.camp.vortex.morathi.intro.001";
	advice_to_play[2] = "wh2.camp.vortex.morathi.intro.002";
	advice_to_play[3] = "wh2.camp.vortex.morathi.intro.003";
	advice_to_play[4] = "wh2.camp.vortex.morathi.intro.004";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		46,																-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_def_cult_of_pleasure/scenes/cult_of_pleasure_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
