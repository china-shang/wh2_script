...
do
	local enemy_faction_str = "wh2_main_brt_knights_of_the_flame";
	local ally_faction_str = "wh2_main_vmp_vampire_coast";
	...
	do
		local personality_key = "wh2_survivor_aggressive";
		
		if difficulty_level == 0 or difficulty_level == -1 then
			personality_key = "wh2_survivor_aggressive";							-- normal/hard
		elseif difficulty_level == -2 or difficulty_level == -3 then
			personality_key = "wh2_survivor_aggressive_hard";						-- v.hard/legendary
		end;
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- The living defile the lands of the dead with their presence, master. They shall be the first victims of my return to Nehekhara.
		"dlc09.camp.vortex.arkhan.early_game.001",
		nil, 
		"dlc09_main_tmb_arkhan_early_game_capture_settlement",
		"PRIEST_NERUTEP",
		"wh2_main_vor_land_of_assassins_lashiek",
		enemy_faction_str,
		{
			"money 1000",
	...
	start_early_game_capture_province_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_capture_province",
		"PRIEST_NERUTEP",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_enact_commandment",
		"PRIEST_NERUTEP",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		...
		9,
		"dlc09_main_tmb_arkhan_early_game_search_ruins",
		"PRIEST_NERUTEP",
		{
			"money 500",
		...
		{		-- factions to modify the personality of
			{
				["faction_key"] = "wh2_main_emp_sudenburg",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_rogue_armies",
		"PRIEST_NERUTEP",
		"wh2_main_rogue_pirates_of_the_southern_ocean",
		{
			{v(418, 258), "wh2_main_vor_land_of_assassins_palace_of_the_wizard_caliph"},
			{v(460, 247), "wh2_main_vor_land_of_the_dervishes_elven_ruins"},
			{v(413, 289), "wh2_main_vor_land_of_assassins_palace_of_the_wizard_caliph"}
		},
	...
	start_early_game_research_tech_mission_listener(
		...
		"dlc09_main_tmb_arkhan_early_game_research_dynasty",
		"PRIEST_NERUTEP",
		{
			"money 1000"
		},
	...
	start_early_game_eliminate_faction_mission_listener(
		-- The enemy recoils before your legions. Let them see your true power Liche Lord, extinguish them.
		"dlc09.camp.vortex.advice.early_game.eliminate_faction.008",
		nil,
		"dlc09_main_tmb_arkhan_early_game_eliminate_faction",
		"PRIEST_NERUTEP",
		enemy_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_upgrade_settlement_part_two",
		"PRIEST_NERUTEP",
		khemri_region_str,
		{
	...
	start_early_game_hero_technology_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_arkhan_early_game_hero_technology_mission", 
		"PRIEST_NERUTEP", 
		{
			"money 500",
			"faction_pooled_resource_transaction{resource tmb_canopic_jars;factor wh2_main_resource_factor_missions;amount " .. early_game_growth_point_mission_canopic_jars_payload_amount .. ";}"
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_hero_recruitment_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_hero_action_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_raise_army_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_non_aggression_pact",
		"PRIEST_NERUTEP",
		ally_faction_str, 
		10,
		{
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_trade_agreement",
		"PRIEST_NERUTEP",
		ally_faction_str,
		3,
		12,
	...
	start_early_game_resources_mission_listener(
		...
		3, 
		"dlc09_main_tmb_arkhan_early_game_resources", 
		"res_rom_textiles", 
		"PRIEST_NERUTEP", 
		{
			"money 500",
	...
	start_early_game_pooled_resource_mission_listener(
		...
		"dlc09_main_tmb_arkhan_early_game_canopic_jars",
		"tmb_canopic_jars",
	...
	start_early_game_mortuary_cult_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_arkhan_early_game_mortuary_cult", 
		"PRIEST_NERUTEP", 
		{
			"money 1000",
	...
	start_early_game_tmb_recruitment_building_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_arkhan_early_game_recruitment_building",
		2,
		{
	...
	start_early_game_tmb_recruitment_building_guide_listener(
		...
		nil,
		"dlc09_main_tmb_arkhan_early_game_recruit_capless_units",
		8,
		"PRIEST_NERUTEP", 
		{
			"money 500",
