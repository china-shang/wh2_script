...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc15.camp.vortex.imrik.intro.001";
	advice_to_play[2] = "wh2_dlc15.camp.vortex.imrik.intro.002";
	advice_to_play[3] = "wh2_dlc15.camp.vortex.imrik.intro.003";
	advice_to_play[4] = "wh2_dlc15.camp.vortex.imrik.intro.004";
	advice_to_play[5] = "wh2_dlc15.camp.vortex.imrik.intro.005";
	
	local cutscene_intro_length = 73.0;
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc15_hef_imrik/scenes/imrik_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
