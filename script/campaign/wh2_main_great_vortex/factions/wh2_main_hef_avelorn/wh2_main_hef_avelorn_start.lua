...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc10.camp.vortex.alarielle.intro.001";
	advice_to_play[2] = "wh2_dlc10.camp.vortex.alarielle.intro.002";
	advice_to_play[3] = "wh2_dlc10.camp.vortex.alarielle.intro.003";
	advice_to_play[4] = "wh2_dlc10.camp.vortex.alarielle.intro.004";
	advice_to_play[5] = "wh2_dlc10.camp.vortex.alarielle.intro.005";
	
	local cutscene_intro_length = 76.0;
	...
	cutscene_intro:action(
		function()
			...
			--cm:set_camera_position(349.6, 399.9, 6.2, 0, 6.2);
			--cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h);
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_hef_avelorn/scenes/avelorn_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
