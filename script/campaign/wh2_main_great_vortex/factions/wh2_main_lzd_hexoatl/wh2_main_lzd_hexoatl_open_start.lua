...
do
	...
	do
		local personality_key = "wh2_pirate_easy";
		
		if difficulty_level == 0 or difficulty_level == -1 then
			personality_key = "wh2_pirate";											-- normal/hard
		elseif difficulty_level == -2 or difficulty_level == -3 then
			personality_key = "wh2_pirate_hard";									-- v.hard/legendary
		end;
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		...
		"wh2.camp.vortex.mazdamundi.early_game.001",
		nil, 
		"wh2_main_lzd_mazdamundi_early_game_capture_settlement",
		"YUKANNADOOZAT",
	...
	start_early_game_gifted_units_listener(
		...
		"event_feed_strings_text_wh2_scripted_event_gifted_units_hexoatl_title", 
		"", 
		"event_feed_strings_text_wh2_scripted_event_gifted_units_hexoatl_secondary_detail", 
		872, 
	...
	start_early_game_capture_province_mission_listener(
		-- The warmbloods spread themselves throughout our sacred jungle to raid lost treasures for their nefarious masters. They must be driven back, and those plaques they have stolen returned to us.
		"wh2.camp.vortex.mazdamundi.early_game.003",
		nil,
		"wh2_main_lzd_mazdamundi_early_game_capture_province",
		"YUKANNADOOZAT",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_enact_commandment",
		"YUKANNADOOZAT",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		-- The wisdom of many lost plaques must be sought to begin the Ritual of Prognostication. Such artefacts can still be found in the most ancient of jungle ruins.
		"wh2.camp.vortex.mazdamundi.early_game.002",
		nil,
		macu_peaks_region_str,
		6,
		"wh2_main_lzd_mazdamundi_early_game_search_ruins",
		"YUKANNADOOZAT",
		{
			"money 500",
		...
		{		-- factions to modify the personality of
			...
			},
			{
				...
				["start_personality_easy"] = "wh2_greenskin_noruins_survivor_easy",
				["start_personality_normal"] = "wh2_greenskin_noruins_survivor",
				["start_personality_hard"] = "wh2_greenskin_noruins_survivor_hard",
				["complete_personality_easy"] = "wh2_greenskin_survivor_easy",
				["complete_personality_normal"] = "wh2_greenskin_survivor",
				["complete_personality_hard"] = "wh2_greenskin_survivor_hard"
			}
		}
	);
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil, 
		"wh2_main_lzd_mazdamundi_early_game_rogue_armies",
		"YUKANNADOOZAT",
		"wh2_main_rogue_vauls_expedition",
		{
			{v(105, 395), "wh2_main_vor_forest_of_the_viper_chotecs_causeway"},
			{v(123, 386), hexoatl_region_str},
			{v(120, 358), "wh2_main_vor_settlers_coast_swamp_town"}
		},
	...
	start_early_game_upgrade_settlement_mission_listener(
		"wh2_main_lzd_mazdamundi_early_game_upgrade_settlement",
		"YUKANNADOOZAT",
	...
	start_early_game_tech_building_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_construct_tech_building",
		"YUKANNADOOZAT",
		{
			"wh2_main_lzd_slann_1",
	...
	start_early_game_research_tech_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_research_tech",
		"YUKANNADOOZAT",
		{
			"money 500"
		}
	...
	start_early_game_public_order_mission_listener(
		-- Recent events have sown disorder within your temple-city, mighty Lord. Take steps to re-establish your will over your Lizard-kin.
		"wh2.camp.vortex.advice.early_game.public_order.020",
		nil,
		"wh2_main_lzd_mazdamundi_early_game_public_order",
		"YUKANNADOOZAT",
		hexoatl_region_str,
		{
			"money 1000"
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_eliminate_faction",
		"YUKANNADOOZAT",
		skeggi_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_upgrade_settlement_part_two",
		"YUKANNADOOZAT",
		hexoatl_region_str,
		"wh2_main_special_settlement_hexoatl_hexoatl_2",
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_hero_building_mission",
		"YUKANNADOOZAT",
		{		
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_hero_recruitment_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_hero_action_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_raise_army_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_non_aggression_pact", 
		"YUKANNADOOZAT", 
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_main_lzd_mazdamundi_early_game_trade_agreement",
		"YUKANNADOOZAT",
		"wh2_main_emp_new_world_colonies",
		3,
		12,
	...
	do
		local ritual_region_key = "wh2_main_vor_forest_of_the_viper_mirror_pool_of_tepok";
		
		local advice_to_show = {
			-- The Mirror Pool of Tepok shimmers with undiscovered secrets, mighty Lord. The plaques you seek may surely be found there in great number.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.040",
			-- Yet a scent of contagion surrounds its waters. Approach with caution, for such a focus of power will surely have drawn other, more malign forces to its shores.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.041"
		};
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 9, {78.7, 323.6, 8.6, 0.28, 5.0}) end, 0);
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 8, {78.6, 323.9, 8.6, -0.2, 5.0}) end, 9);
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 8, {77.3, 294.4, 22.1, 0.02, 17.0}) end, 16);
		...
		start_early_game_ritual_settlement_capture_mission_listener(
			...
			nil, 
			0.5, 
			"wh2_main_lzd_mazdamundi_early_game_capture_ritual_settlement", 
			"YUKANNADOOZAT", 
			ritual_region_key, 
			12,
			{
		...
		start_early_game_ritual_building_mission_listener(
			-- The pestilent warmbloods are driven from the shrine, mighty Lord. The search for plaques may commence there once suitable facilities are constructed. Make all haste - you no doubt sense the decline of the Vortex for yourself.
			"wh2.camp.vortex.advice.early_game.ritual_buildings.040", 
			nil,
			"wh2_main_lzd_mazdamundi_early_game_construct_ritual_building", 
			"YUKANNADOOZAT", 
			ritual_region_key, 
	...
	do
		...
		local enact_ritual_mission_key = "wh2_main_lzd_mazdamundi_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			-- Much wisdom has been gained from those plaques recovered, my children, but many more are required. The search must continue, lest the warmblood plans reach fruition first.
			"wh2.camp.vortex.mazdamundi.early_game.004",
			{
				1,
			...
			30,
			"wh2_main_lzd_mazdamundi_early_game_earn_ritual_currency",
			"YUKANNADOOZAT",
		...
		start_early_game_ritual_mission_listener(
			-- The ritual is ready. Let us commune for its initiation.
			"wh2.camp.vortex.mazdamundi.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
