...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2.camp.vortex.mazdamundi.intro.001";
	advice_to_play[2] = "wh2.camp.vortex.mazdamundi.intro.002";
	advice_to_play[3] = "wh2.camp.vortex.mazdamundi.intro.003";
	advice_to_play[4] = "wh2.camp.vortex.mazdamundi.intro.004";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		58.5,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_lzd_hexoatl/scenes/hexoatl_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
...
initial_enemy_force_x = 111;
initial_enemy_force_y = 385;

second_enemy_force_start_x = 141;
second_enemy_force_start_y = 379;
...
function create_second_enemy_force()
	cm:create_force_with_general(
		...
		skeggi_faction_str,
		"wh_main_nor_inf_chaos_marauders_0,wh_main_nor_inf_chaos_marauders_0,wh_main_nor_inf_chaos_marauders_0,wh_main_nor_inf_chaos_marauders_0,wh_dlc08_nor_inf_marauder_hunters_1,wh_main_chs_art_hellcannon",
		glittering_tower_region_str,
		second_enemy_force_start_x,
		second_enemy_force_start_y,
		"general",
		"nor_marauder_chieftain",
		"names_name_2147345693",		-- Lamont
		"",
		"",
		"",
		false
...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		if cm:get_saved_value("bool_prelude_first_turn_was_loaded") then
			cm:set_public_order_of_province_for_region(hexoatl_region_str, -34);
		end;
		
		-- set enemy faction personality
		cm:force_change_cai_faction_personality(skeggi_faction_str, "wh_script_foolishly_brave");
