...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc09.camp.vortex.tretch.intro.001";
	advice_to_play[2] = "dlc09.camp.vortex.tretch.intro.002";
	advice_to_play[3] = "dlc09.camp.vortex.tretch.intro.003";
	advice_to_play[4] = "dlc09.camp.vortex.tretch.intro.004";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		43.5,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc09_skv_clan_rictus/scenes/clan_rictus_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
