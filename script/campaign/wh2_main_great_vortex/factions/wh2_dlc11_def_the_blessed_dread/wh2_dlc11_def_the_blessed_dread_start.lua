...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc11.camp.vortex.Lokhir_Fellheart.intro.001";
	advice_to_play[2] = "wh2_dlc11.camp.vortex.Lokhir_Fellheart.intro.002";
	advice_to_play[3] = "wh2_dlc11.camp.vortex.Lokhir_Fellheart.intro.003";
	advice_to_play[4] = "wh2_dlc11.camp.vortex.Lokhir_Fellheart.intro.004";
	advice_to_play[5] = "wh2_dlc11.camp.vortex.Lokhir_Fellheart.intro.005";
	advice_to_play[6] = "wh2_dlc11.camp.vortex.Lokhir_Fellheart.intro.006";
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc11_def_the_blessed_dread/scenes/the_blessed_dread_flyby_scene_01.CindyScene", 0, 5);
		end,
		0
	);
