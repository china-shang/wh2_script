...
do
	...
	enemy_initial_lord_char_cqi = cm:get_cached_value(
		...
		function()
			local character = cm:get_closest_general_to_position_from_faction(cm:get_faction(clan_mordkin_faction_str), 655, 131, false);
			if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- The Rat-spawn hoard plaques wrenched from ancient temples. Lord Mazdamundi bids us to strike. Recover sacred artefacts and discover enemy trespasser schemes.
		"wh2.camp.vortex.kroqgar.early_game.001",
		{
			1,
		...
		"wh2_main_lzd_kroqgar_early_game_capture_settlement",
		"YUKANNADOOZAT",
		enemy_initial_lord_char_cqi,
		clan_mordkin_faction_str,
		{
	...
	start_early_game_capture_province_mission_listener(
		-- Rat-spawn seek territory to uncover more plaques. They must be denied! Ours is the only roar to rule the world!
		"wh2.camp.vortex.kroqgar.early_game.003",
		nil,
		"wh2_main_lzd_kroqgar_early_game_capture_province",
		"YUKANNADOOZAT",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_enact_commandment",
		"YUKANNADOOZAT",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		-- Many plaques hidden in lost ruins. Revered master demands we find them. The Sotek reviled Rat-spawn must not reach them.
		"wh2.camp.vortex.kroqgar.early_game.002",
		nil,
		the_cursed_jungle_region_str,
		6,
		"wh2_main_lzd_kroqgar_early_game_search_ruins",
		"YUKANNADOOZAT",
		{
			"money 500",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_rogue_armies",
		"YUKANNADOOZAT",
	...
	start_early_game_tech_building_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_construct_tech_building",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_research_tech_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_research_tech",
		"YUKANNADOOZAT",
		{
			"money 500"
		}
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_eliminate_faction",
		"YUKANNADOOZAT",
		clan_mordkin_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_upgrade_settlement_part_two",
		"YUKANNADOOZAT",
		temple_of_skulls_region_str,
		{
			"wh2_main_lzd_outpostnorsca_major_2",
			"wh2_main_lzd_outpostnorsca_major_2_coast",
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_hero_building_mission",
		"YUKANNADOOZAT",
		{		
			"wh2_main_lzd_outpostnorsca_major_3",
			"wh2_main_lzd_outpostnorsca_major_3_coast",
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_hero_recruitment_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_hero_action_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_raise_army_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_non_aggression_pact",
		"YUKANNADOOZAT",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_main_lzd_kroqgar_early_game_trade_agreement",
		"YUKANNADOOZAT",
		"wh2_main_wef_bowmen_of_oreon",
		3,
		12,
	...
	do
		...
		local advice_to_show = {
			...
			-- Yet others of your cold-blooded kind hold them from you, in misguided service to their own masters. When you strike, and strike you must, then war is inevitable.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.051"
		};
		...
		start_early_game_ritual_settlement_capture_mission_listener(
			...
			nil,
			0.5,
			"wh2_main_lzd_kroqgar_early_game_capture_ritual_settlement",
			"YUKANNADOOZAT",
			ritual_region_key,
			12,
			{
		...
		start_early_game_ritual_building_mission_listener(
			...
			nil,
			"wh2_main_lzd_kroqgar_early_game_construct_ritual_building",
			"YUKANNADOOZAT",
			ritual_region_key,
	...
	do
		...
		local enact_ritual_mission_key = "wh2_main_lzd_kroqgar_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			-- Great insight is gained through recovered plaques, yet revered master Mazdamundi needs more. He prepares a ritual to seek the wisdom of the Old Ones.
			"wh2.camp.vortex.kroqgar.early_game.004",
			{
				1,
			...
			30,
			"wh2_main_lzd_kroqgar_early_game_earn_ritual_currency",
			"YUKANNADOOZAT",
		...
		start_early_game_ritual_mission_listener(
			-- Revered master communes, the time of the ritual is at hand. Let us join for its completion.
			"wh2.camp.vortex.kroqgar.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
