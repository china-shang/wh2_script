...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc11.camp.vortex.Luthor_Harkon.intro.001";
	advice_to_play[2] = "wh2_dlc11.camp.vortex.Luthor_Harkon.intro.002";
	advice_to_play[3] = "wh2_dlc11.camp.vortex.Luthor_Harkon.intro.003";
	advice_to_play[4] = "wh2_dlc11.camp.vortex.Luthor_Harkon.intro.004";
	advice_to_play[5] = "wh2_dlc11.camp.vortex.Luthor_Harkon.intro.005";
	advice_to_play[6] = "wh2_dlc11.camp.vortex.Luthor_Harkon.intro.006";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		144.5,															-- length of cutscene in seconds
	...
	cutscene_intro:set_skip_camera(cam_end_x, cam_end_y, cam_end_d, cam_end_b, cam_end_h);
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc11_cst_vampire_coast/scenes/vampire_coast_flyby.CindyScene", 0, 5);
		end,
		0
	);
...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		out("disabling diplomacy options for harkon");
		cm:force_diplomacy("faction:" .. "wh2_dlc11_cst_vampire_coast", "faction:" .. "wh2_dlc11_cst_vampire_coast_rebels", "peace", false, false, true);
	end
);
