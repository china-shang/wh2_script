...
do
	...
	do
		...
		start_early_game_diplomacy_setup_listener(
			vampire_coast_rebels_faction_str,
			personality_key,
			3
		);
	end;
	...
	do
		local char_cqi = cm:get_cached_value(
			...
			function()
				local character = cm:get_closest_general_to_position_from_faction(vampire_coast_rebels_faction_str, 276, 313, false);
				if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- Challengers approach, the fools do not realise they are heading straight into my trap. The Sea Shanty they hold will be mine, victory over these insignificant sea dogs will take me one step closer to conquering the beast beneath the sea. 
		"wh2_dlc11.camp.vortex.LuthorHarkon.early_game.001",
		nil, 
		"wh2_dlc11_cst_harkon_early_game_capture_settlement",
		"SYMBOLS",
		pox_marsh_region_str,
		vampire_coast_rebels_faction_str,
		{
			"money 1000",
	...
	start_early_game_capture_province_mission_listener(
		-- The first step to regaining my territory has been taken but this is not enough. I will not rest until I have conquered all the Coast again, and then all of Lustria. The dead will rule this continent and I will be their master!
		"wh2_dlc11.camp.vortex.LuthorHarkon.early_game.003",
		nil,
		"wh2_dlc11_cst_harkon_early_game_capture_province",
		"SYMBOLS",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_enact_commandment",
		"SYMBOLS",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		-- Even the foundations of this land will not outlive me, the ruins of this once great city are all that remain. Though these temples have fallen their treasures and secrets remain, waiting for a worthy reclaimer! Though I must be careful, I will not suffer another trap – my mind will struggle such an assault whilst I am still recovering.
		"wh2_dlc11.camp.vortex.LuthorHarkon.early_game.002",
		nil,
		the_blood_swamps_region_str,
		6,
		"wh2_dlc11_cst_harkon_early_game_search_ruins",
		"SYMBOLS",
		{
			"money 500",
			"faction_pooled_resource_transaction{resource cst_infamy;factor wh2_main_resource_factor_missions;amount " .. early_game_search_ruins_mission_infamy_payload_amount .. ";}"
		},
		{		-- factions to modify the personality of
			{
				["faction_key"] = xlanhuapec_faction_str,
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_rogue_armies",
		"SYMBOLS",
		"wh2_main_rogue_worldroot_rangers",
		{
			{v(273, 228), the_blood_swamps_region_str},
			{v(247, 254), the_blood_swamps_region_str},
			{v(258, 236), the_blood_swamps_region_str}
		},
		...
		{
			"money 2000",
			"faction_pooled_resource_transaction{resource cst_infamy;factor wh2_main_resource_factor_missions;amount " .. early_game_rogue_army_mission_infamy_payload_amount .. ";}"
		}
	);
	...
	start_early_game_eliminate_faction_mission_listener(
		nil,
		nil,
		"wh2_dlc11_cst_harkon_early_game_eliminate_faction",
		"SYMBOLS",
		vampire_coast_rebels_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_upgrade_settlement_part_two",
		"SYMBOLS",
		the_awakening_region_str,
		{
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_hero_building_mission",
		"SYMBOLS",
		{	
...
--temp buildings until agent recruitment has been tied to a particular chain
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_hero_recruitment_mission",
		"SYMBOLS",
		{
			"money 500",
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_hero_action_mission",
		"SYMBOLS",
		{
			"money 500",
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_raise_army_mission",
		"SYMBOLS",
		{
			"money 500",
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_non_aggression_pact", 
		"SYMBOLS",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_trade_agreement",
		"SYMBOLS",
		noctilus_faction_str,
		3,
		12,
	...
	start_early_game_cst_pirate_cove_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_pirate_cove_mission",
		"SYMBOLS",
		{		
	...
	start_early_game_cst_growth_point_ship_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_ship_building",
		"SYMBOLS",
	...
	start_early_game_cst_loyalty_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_harkon_early_game_loyalty_mission",
		"SYMBOLS",
		vampire_coast_faction_str,
		{
			"money 1000",
	...
	start_early_game_cst_treasure_hunting_mission_listener(
		...
		nil,
		"wh2_dlc11_cst_treasure_map_starting_treasure_luthor"
	);
