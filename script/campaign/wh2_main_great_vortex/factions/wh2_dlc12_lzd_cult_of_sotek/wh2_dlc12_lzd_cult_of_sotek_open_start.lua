...
do
	...
	enemy_initial_lord_char_cqi = cm:get_cached_value(
		...
		function()
			local character = cm:get_closest_general_to_position_from_faction(cm:get_faction(clan_fester_faction_str), 234, 52, false);
			if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- The foul taint of the rat-spawn has once again taken its hold over Lustria, only the mighty Sotek can purge this plague-filth once and for all. The first step in fulfilling the Great Prophecy will start with sacrificing the vermin that infest this settlement and recovering the Sacred Plaques within.
		"wh2_dlc12.camp.vortex.tehenhauin.early_game.001",
		{
			1,
		...
		"wh2_dlc12_lzd_tehenhauin_early_game_capture_settlement",
		"YUKANNADOOZAT",
		enemy_initial_lord_char_cqi,
		clan_fester_faction_str,
		{
	...
	start_early_game_capture_province_mission_listener(
		-- Plagues. Corruption. Filth. The rat-spawn have pushed far into Lustria and only a concentrated and unrelenting assault on the vermin will relieve us of their presence. Sotek’s rise is foretold but his strength comes with a price; we must take all the rat-spawn territory and sacrifice their lives to Sotek – this time their race will not survive the maw of Sotek
		"wh2_dlc12.camp.vortex.tehenhauin.early_game.003",
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_capture_province",
		"YUKANNADOOZAT",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_enact_commandment",
		"YUKANNADOOZAT",
		{
			"money 500",
			"faction_pooled_resource_transaction{resource lzd_sacrificial_offerings;factor wh2_dlc12_resource_factor_sacrifices_missions;amount 100;}"
		}
	);
	...
	start_early_game_search_ruins_mission_listener(		
		-- Many plaques yet remain hidden, and the pox-ridden vermin no doubt harbour them. They are only fit to be sacrificed to Sotek, we must push chase them out of their burrows and onto the sacrificial altars – may the Great Serpent rise again!
		"wh2_dlc12.camp.vortex.tehenhauin.early_game.002",
		nil,
		xlansec_region_str,
		6,
		"wh2_dlc12_lzd_tehenhauin_early_game_search_ruins",
		"YUKANNADOOZAT",
		{
			"money 500",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_rogue_armies",
		"YUKANNADOOZAT",
	...
	start_early_game_tech_building_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_construct_tech_building",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_research_tech_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_research_tech",
		"YUKANNADOOZAT",
		{
			"money 500",
			"faction_pooled_resource_transaction{resource lzd_sacrificial_offerings;factor wh2_dlc12_resource_factor_sacrifices_missions;amount 100;}"
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_eliminate_faction",
		"YUKANNADOOZAT",
		clan_fester_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_upgrade_settlement_part_two",
		"YUKANNADOOZAT",
		"wh2_main_vor_culchan_plains_kaiax",
		{
			"wh2_main_lzd_settlement_major_2_coast"
		},
		{
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_hero_building_mission",
		"YUKANNADOOZAT",
		{		
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_hero_recruitment_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_hero_action_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_raise_army_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_non_aggression_pact",
		"YUKANNADOOZAT",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_dlc12_lzd_tehenhauin_early_game_trade_agreement",
		"YUKANNADOOZAT",
		southern_sentinels_faction_str,
		3,
		12,
	...
	do
		local ritual_region_key = "wh2_main_vor_copper_desert_the_dust_gate";
		...
		start_early_game_ritual_building_mission_listener(
			...
			nil,
			"wh2_dlc12_lzd_tehenhauin_early_game_construct_ritual_building",
			"YUKANNADOOZAT",
			ritual_region_key,
	...
	do
		...
		local enact_ritual_mission_key = "wh2_dlc12_lzd_tehenhauin_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			-- Sacred Plaques hold knowledge and prophecies long forgotten – the Plaque of Sotek is testament to the power we can pull forth, but we must seek out these plaques first; and gather them if we wish to begin the great Ritual.
			"wh2_dlc12.camp.vortex.tehenhauin.early_game.004",
			{
				1,
			...
			30,
			"wh2_dlc12_lzd_tehenhauin_early_game_earn_ritual_currency",
			"YUKANNADOOZAT",
		...
		start_early_game_ritual_mission_listener(
			-- The time has come, the first of many rituals is prepared – by stabilising the Vortex we guarantee Sotek’s return. 
			"wh2_dlc12.camp.vortex.tehenhauin.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
