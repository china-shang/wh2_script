...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc12.camp.vortex.flyby.lzd.tehenhauin.001";
	advice_to_play[2] = "dlc12.camp.vortex.flyby.lzd.tehenhauin.002";
	advice_to_play[3] = "dlc12.camp.vortex.flyby.lzd.tehenhauin.003";
	advice_to_play[4] = "dlc12.camp.vortex.flyby.lzd.tehenhauin.004";
	advice_to_play[5] = "dlc12.camp.vortex.flyby.lzd.tehenhauin.005";
	advice_to_play[6] = "dlc12.camp.vortex.flyby.lzd.tehenhauin.006";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		93,																-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc12_lzd_cult_of_sotek/scenes/wh2_dlc12_lzd_cult_of_sotek.CindyScene", 0, 10);
		end,
		0
	);
