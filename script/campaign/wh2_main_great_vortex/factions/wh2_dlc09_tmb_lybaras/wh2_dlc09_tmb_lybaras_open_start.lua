...
do
	local enemy_faction_str = sentinels_of_xeti_faction_str;
	local ally_faction_str = "wh2_main_def_blood_hall_coven";
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- Simple creatures! They search the jungles for their miserable relics, caring not that they encroach against the Khalida, the avatar of Asaph! Death shall find them!
		"dlc09.camp.vortex.khalida.early_game.001",
		nil, 
		"dlc09_main_tmb_khalida_early_game_capture_settlement",
		"PRIEST_NERUTEP",
		"wh2_main_vor_copper_desert_the_dust_gate",
		enemy_faction_str,
		{
			"money 1000",
	...
	start_early_game_capture_province_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_capture_province",
		"PRIEST_NERUTEP",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_enact_commandment",
		"PRIEST_NERUTEP",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		...
		9,
		"dlc09_main_tmb_khalida_early_game_search_ruins",
		"PRIEST_NERUTEP",
		{
			"money 500",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_rogue_armies",
		"PRIEST_NERUTEP",
		"wh2_main_rogue_the_wandering_dead",
		{
			{v(178, 53), "wh2_main_vor_copper_desert_the_dust_gate"},
			{v(215, 52), "wh2_main_vor_copper_desert_the_dust_gate"},
			{v(122, 71), "wh2_main_vor_copper_desert_the_golden_colossus"}
		},
	...
	start_early_game_research_tech_mission_listener(
		...
		"dlc09_main_tmb_khalida_early_game_research_dynasty",
		"PRIEST_NERUTEP",
		{
			"money 1000"
		},
	...
	start_early_game_eliminate_faction_mission_listener(
		-- The enemy recoils before your legions. Asaph desires their destruction!
		"dlc09.camp.vortex.advice.early_game.eliminate_faction.007",
		nil,
		"dlc09_main_tmb_khalida_early_game_eliminate_faction",
		"PRIEST_NERUTEP",
		enemy_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_upgrade_settlement_part_two",
		"PRIEST_NERUTEP",
		the_forgotten_isles_region_str,
		{
	...
	start_early_game_hero_technology_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_khalida_early_game_hero_technology_mission", 
		"PRIEST_NERUTEP", 
		{
			"money 500",
			"faction_pooled_resource_transaction{resource tmb_canopic_jars;factor wh2_main_resource_factor_missions;amount " .. early_game_growth_point_mission_canopic_jars_payload_amount .. ";}"
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_hero_recruitment_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_hero_action_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_raise_army_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_non_aggression_pact",
		"PRIEST_NERUTEP",
		ally_faction_str, 
		10,
		{
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_trade_agreement",
		"PRIEST_NERUTEP",
		ally_faction_str,
		3,
		12,
	...
	start_early_game_resources_mission_listener(
		...
		nil, 
		"wh2_main_vor_copper_desert_the_golden_colossus",
		3, 
		"dlc09_main_tmb_khalida_early_game_resources", 
		"res_rom_marble", 
		"PRIEST_NERUTEP", 
		{
			"money 500",
	...
	start_early_game_pooled_resource_mission_listener(
		...
		"dlc09_main_tmb_khalida_early_game_canopic_jars",
		"tmb_canopic_jars",
	...
	start_early_game_mortuary_cult_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_khalida_early_game_mortuary_cult", 
		"PRIEST_NERUTEP", 
		{
			"money 1000",
	...
	start_early_game_tmb_recruitment_building_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_khalida_early_game_recruitment_building",
		2,
		{
	...
	start_early_game_tmb_recruitment_building_guide_listener(
		...
		nil,
		"dlc09_main_tmb_khalida_early_game_recruit_capless_units",
		8,
		"PRIEST_NERUTEP", 
		{
			"money 500",
