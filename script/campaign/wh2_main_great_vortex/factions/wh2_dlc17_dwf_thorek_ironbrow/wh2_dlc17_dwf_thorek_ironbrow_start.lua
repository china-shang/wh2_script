...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc17.camp.vortex.flyby.thorek.001";
	advice_to_play[2] = "wh2_dlc17.camp.vortex.flyby.thorek.002";
	advice_to_play[3] = "wh2_dlc17.camp.vortex.flyby.thorek.003";
	advice_to_play[4] = "wh2_dlc17.camp.vortex.flyby.thorek.004";
	
	local cutscene_intro_length = 68.0;
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc17_dwf_thorek_ironbrow/scenes/vortex_thorek_flyby_01.CindyScene", 0, 5);
		end,
		0
	);
