...
do
	...
	do
		local char_cqi = cm:get_cached_value(
			...
			function()
				local character = cm:get_closest_general_to_position_from_faction(ghrond_faction_str, 125, 519, false);
				if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		...
		"wh2_dlc10.camp.vortex.hellebron.early_game.001",
		nil, 
		"wh2_main_def_hellebron_early_game_capture_settlement",
		"FELICION",
		spite_reach_region_str,
		ghrond_faction_str,
		{
			"money 1000",
	...
	start_early_game_capture_province_mission_listener(
		...
		"wh2_dlc10.camp.vortex.hellebron.early_game.003",
		nil,
		"wh2_main_def_hellebron_early_game_capture_province",
		"FELICION",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_enact_commandment",
		"FELICION",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		...
		"wh2_dlc10.camp.vortex.hellebron.early_game.002",
		nil,
		kauark_region_str,
		6,
		"wh2_main_def_hellebron_early_game_search_ruins",
		"FELICION",
		{
			"money 500",
		...
		{		-- factions to modify the personality of
			{
				["faction_key"] = "wh2_main_def_deadwood_sentinels",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_rogue_armies",
		"FELICION",
		"wh2_main_rogue_scions_of_tesseninck",
		{
			{v(304, 696), kauark_region_str},
			{v(311, 685), kauark_region_str},
			{v(291, 679), kauark_region_str}
		},
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_eliminate_faction",
		"FELICION",
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_upgrade_settlement_part_two",
		"FELICION",
		har_ganeth_region_str,
		{
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_hero_building_mission",
		"FELICION",
		{		
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_hero_recruitment_mission",
		"FELICION",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_hero_action_mission",
		"FELICION",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_raise_army_mission",
		"FELICION",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_non_aggression_pact", 
		"FELICION",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_main_def_hellebron_early_game_trade_agreement",
		"FELICION",
		"wh2_main_def_clar_karond",
		3,
		12,
	...
	do
		...
		local advice_to_show = {
			-- Scrolls of great power may be found within the deepest vaults of the enemy capital, Blood Queen. Yet the Dark Convent of Ghrond squander these energies in service to their pitiful sourcery.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.080",
			-- Ghrond is well defended, but an attack is surely necessary to secure its scrolls for your own cause.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.081"
		};
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 8, {180.6, 509.4, 31.3, 0.0, 21.1}) end, 16);
		...
		start_early_game_ritual_settlement_capture_mission_listener(
			...
			nil, 
			0.5, 
			"wh2_main_def_hellebron_early_game_capture_ritual_settlement", 
			"FELICION",
			ritual_region_key, 
			12,
			{
		...
		start_early_game_ritual_building_mission_listener(
			-- Ghrond has fallen in a battle of delightful savagery, Blood Queen. Construct facilities at once to enable your search for the scrolls you seek. I sense that the Vortex dims further.
			"wh2_dlc10.camp.vortex.early_game.ritual_buildings.090", 
			nil,
			"wh2_main_def_hellebron_early_game_construct_ritual_building", 
			"FELICION",
			ritual_region_key, 
	...
	do
		...
		local enact_ritual_mission_key = "wh2_main_def_hellebron_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			...
			"wh2_dlc10.camp.vortex.hellebron.early_game.004",
			{
				1,
			...
			30,
			"wh2_main_def_hellebron_early_game_earn_ritual_currency",
			"FELICION",
		...
		start_early_game_ritual_mission_listener(
			...
			"wh2_dlc10.camp.vortex.hellebron.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
