...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc10.camp.vortex.hellebron.intro.001";
	advice_to_play[2] = "wh2_dlc10.camp.vortex.hellebron.intro.002";
	advice_to_play[3] = "wh2_dlc10.camp.vortex.hellebron.intro.003";
	advice_to_play[4] = "wh2_dlc10.camp.vortex.hellebron.intro.004";
	advice_to_play[5] = "wh2_dlc10.camp.vortex.hellebron.intro.005";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		57.0,																-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_def_har_ganeth/scenes/har_ganeth_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
