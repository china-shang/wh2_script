...
do
	...
	enemy_initial_lord_char_cqi = cm:get_cached_value(
		...
		function()
			local character = cm:get_closest_general_to_position_from_faction(cm:get_faction(clan_fester_faction_str), 199, 198, false);
			if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- PH
		"wh2_dlc13.camp.vortex.gorrok.early_game.001",
		{
			1,
		...
		"wh2_dlc13_lzd_gorrok_early_game_capture_settlement",
		"YUKANNADOOZAT",
		enemy_initial_lord_char_cqi,
		clan_fester_faction_str,
		{
	...
	start_early_game_capture_province_mission_listener(
		-- PH 
		"wh2_dlc13.camp.vortex.gorrok.early_game.003",
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_capture_province",
		"YUKANNADOOZAT",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_enact_commandment",
		"YUKANNADOOZAT",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		-- Ancient plaques lost in ruins. Master commands we go now.
		"wh2_dlc13.camp.vortex.gorrok.early_game.002",
		nil,
		"wh2_main_vor_river_qurveza_axlotl",
		5,
		"wh2_dlc13_lzd_gorrok_early_game_search_ruins",
		"YUKANNADOOZAT",
		{
			"money 500",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_rogue_armies",
		"YUKANNADOOZAT",
		"wh2_main_rogue_scions_of_tesseninck",
		{
			{v(242, 202), "wh2_main_vor_river_qurveza_axlotl"},
			{v(225, 161), "wh2_main_vor_river_qurveza_axlotl"},
			{v(246, 176), "wh2_main_vor_river_qurveza_axlotl"}
		},
	...
	start_early_game_tech_building_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_construct_tech_building",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_research_tech_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_research_tech",
		"YUKANNADOOZAT",
		{
			"money 500"
		}
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_eliminate_faction",
		"YUKANNADOOZAT",
		clan_fester_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_upgrade_settlement_part_two",
		"YUKANNADOOZAT",
		"wh2_main_vor_northern_great_jungle_itza",
		{
			"wh2_main_special_settlement_itza_itza_2"
		},
		{
			"wh2_main_special_settlement_itza_itza_3"
		},
		{
			"money 1000",
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_hero_building_mission",
		"YUKANNADOOZAT",
		{		
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_hero_recruitment_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_hero_action_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_raise_army_mission",
		"YUKANNADOOZAT",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_non_aggression_pact",
		"YUKANNADOOZAT",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"wh2_dlc13_lzd_gorrok_early_game_trade_agreement",
		"YUKANNADOOZAT",
		southern_sentinels_faction_str,
		3,
		12,
	...
	do
		...
		local advice_to_show = {
			-- This region has long held ancient secrets, but dangers also lie within.
			"wh2_dlc13.camp.vortex.early_game.ritual_settlement.130",
			-- Seizing this region is sure to reward you with many Plaques, mighty lord. Attack and claim it for the Great Plan!
			"wh2_dlc13.camp.vortex.early_game.ritual_settlement.131"
		};
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 8, {130.9, 145.1, 24.3, 0.04, 20.0}) end, 16);
		...
		start_early_game_ritual_settlement_capture_mission_listener(
			...
			nil, 
			0.5, 
			"wh2_dlc13_lzd_gorrok_early_game_capture_ritual_settlement", 
			"YUKANNADOOZAT", 
			ritual_region_key, 
			12,
			{
		...
		start_early_game_ritual_building_mission_listener(
			-- PH
			"wh2_dlc13.camp.vortex.early_game.ritual_buildings.130", 
			nil,
			"wh2_dlc13_lzd_gorrok_early_game_construct_ritual_building",
			"YUKANNADOOZAT",
			ritual_region_key,
	...
	do
		...
		local enact_ritual_mission_key = "wh2_dlc13_lzd_gorrok_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			-- PH
			"wh2_dlc13.camp.vortex.gorrok.early_game.004",
			{
				1,
			...
			30,
			"wh2_dlc13_lzd_gorrok_early_game_earn_ritual_currency",
			"YUKANNADOOZAT",
		...
		start_early_game_ritual_mission_listener(
			-- PH
			"wh2_dlc13.camp.vortex.gorrok.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
