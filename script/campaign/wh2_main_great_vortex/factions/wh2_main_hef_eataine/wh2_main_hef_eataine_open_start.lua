...
if not cm:is_benchmark_mode() then
	...
	do
		local char_cqi = cm:get_cached_value(
			...
			function()
				local character = cm:get_faction(cult_of_excess_faction_str):faction_leader();
				if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		...
		"wh2.camp.vortex.tyrion.early_game.001",
		nil, 
		"wh2_main_hef_tyrion_early_game_capture_settlement",
		"LOREMASTER_TALARIAN",
	...
	start_early_game_gifted_units_listener(
		...
		"event_feed_strings_text_wh2_scripted_event_gifted_units_eataine_title", 
		"", 
		"event_feed_strings_text_wh2_scripted_event_gifted_units_eataine_secondary_detail", 
		870, 
	...
	start_early_game_capture_province_mission_listener(
		...
		"wh2.camp.vortex.tyrion.early_game.003",
		nil,
		"wh2_main_hef_tyrion_early_game_capture_province",
		"LOREMASTER_TALARIAN",
		{
			"money 2000",
			"influence 5",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_enact_commandment",
		"LOREMASTER_TALARIAN",
		{
			"money 500",
			"influence 2"
	...
	start_early_game_search_ruins_mission_listener(		
		...
		"wh2.camp.vortex.tyrion.early_game.002",
		nil,
		caledors_repose_region_str,
		6,
		"wh2_main_hef_tyrion_early_game_search_ruins",
		"LOREMASTER_TALARIAN",
		{
			"money 500",
			"influence 1",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil, 
		"wh2_main_hef_tyrion_early_game_rogue_armies",
		"LOREMASTER_TALARIAN",
		"wh2_main_rogue_teef_snatchaz", 
		{
			{v(487, 424), lothern_region_str},
			{v(455, 442), "wh2_main_vor_caledor_tor_sethai"},
			{v(510, 440), lothern_region_str},
			{v(506, 422), lothern_region_str}
		},
	...
	start_early_game_upgrade_settlement_mission_listener(
		"wh2_main_hef_tyrion_early_game_upgrade_settlement",
		"LOREMASTER_TALARIAN",
	...
	start_early_game_tech_building_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_construct_tech_building",
		"LOREMASTER_TALARIAN",
		{
	...
	start_early_game_research_tech_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_research_tech",
		"LOREMASTER_TALARIAN",
		{
			"money 500",
			"influence 1"
	...
	start_early_game_public_order_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_public_order",
		"LOREMASTER_TALARIAN",
		lothern_region_str,
		{
			"money 1000",
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_eliminate_faction",
		"LOREMASTER_TALARIAN",
		cult_of_excess_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_upgrade_settlement_part_two",
		"LOREMASTER_TALARIAN",
		lothern_region_str,
		"wh2_main_special_settlement_lothern_2",
		"wh2_main_special_settlement_lothern_3",
		{
			"money 1000",
			"influence 1",
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_hero_building_mission",
		"LOREMASTER_TALARIAN",
		{
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_hero_recruitment_mission",
		"LOREMASTER_TALARIAN",
		{
			"influence 1",
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_hero_action_mission",
		"LOREMASTER_TALARIAN",
		{
			"influence 1",
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_raise_army_mission",
		"LOREMASTER_TALARIAN",
		{
			"influence 2",
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_main_hef_tyrion_early_game_non_aggression_pact", 
		"LOREMASTER_TALARIAN",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		"wh2_main_hef_tyrion_early_game_trade_agreement",
		"LOREMASTER_TALARIAN",
		"wh2_main_hef_yvresse",
		3,
		12,
	...
	do
		local ritual_region_key = "wh2_main_vor_caledor_vauls_anvil";
		
		local advice_to_show = {
			-- The princes of Caledor have had much success in finding wayshards around their volcano, yet they refuse to contribute to the war effort.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.001",
			-- Making war amongst your own kind is unpalatable, but an occupation of the city may be necessary to acquire the wayshards uncovered there.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.002"
		};
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 9, {301.7, 315.3, 8.6, -0.83, 5.0}) end, 0);
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 8, {301.9, 315.7, 8.6, -0.33, 5.0}) end, 9);
		...
		cutscene:action(function() cm:scroll_camera_from_current(false, 8, {305.6, 316.2, 22.8, 0, 18.0}) end, 16);
		...
		start_early_game_ritual_settlement_capture_mission_listener(
			...
			nil, 
			0.5, 
			"wh2_main_hef_tyrion_early_game_capture_ritual_settlement",
			"LOREMASTER_TALARIAN",
			ritual_region_key, 
			12,
			{
		...
		start_early_game_ritual_building_mission_listener(
			-- Caledor has fallen to you, my Lord. The hubris of the Dragon Princes has led to their ruination by your hand. Be sure to begin the search for wayshards - the Vortex becomes more unstable with each passing day.
			"wh2.camp.vortex.advice.early_game.ritual_buildings.001", 
			nil,
			"wh2_main_hef_tyrion_early_game_construct_ritual_building",
			"LOREMASTER_TALARIAN",
			ritual_region_key, 
	...
	do
		...
		local enact_ritual_mission_key = "wh2_main_hef_tyrion_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			...
			"wh2.camp.vortex.tyrion.early_game.004",
			{
				1,
			...
			30,
			"wh2_main_hef_tyrion_early_game_earn_ritual_currency",
			"LOREMASTER_TALARIAN",
		...
		start_early_game_ritual_mission_listener(
			...
			"wh2.camp.vortex.tyrion.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
