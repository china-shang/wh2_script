...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc15.camp.vortex.eltharion.intro.001";
	advice_to_play[2] = "wh2_dlc15.camp.vortex.eltharion.intro.002";
	advice_to_play[3] = "wh2_dlc15.camp.vortex.eltharion.intro.003";
	advice_to_play[4] = "wh2_dlc15.camp.vortex.eltharion.intro.004";
	advice_to_play[5] = "wh2_dlc15.camp.vortex.eltharion.intro.005";
	
	local cutscene_intro_length = 69.0;
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_hef_yvresse/scenes/yvresse_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
