...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc12.camp.vortex.flyby.lzd.tiktaqto.001";
	advice_to_play[2] = "dlc12.camp.vortex.flyby.lzd.tiktaqto.002";
	advice_to_play[3] = "dlc12.camp.vortex.flyby.lzd.tiktaqto.003";
	advice_to_play[4] = "dlc12.camp.vortex.flyby.lzd.tiktaqto.004";
	advice_to_play[5] = "dlc12.camp.vortex.flyby.lzd.tiktaqto.005";
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_lzd_tlaqua/scenes/wh2_main_lzd_tlaqua.CindyScene", 0, 6);
		end,
		0
	);
