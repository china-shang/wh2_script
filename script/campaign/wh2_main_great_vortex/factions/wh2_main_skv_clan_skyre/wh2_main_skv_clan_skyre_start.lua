...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc12.camp.vortex.flyby.skv.ikit.001";
	advice_to_play[2] = "dlc12.camp.vortex.flyby.skv.ikit.002";
	advice_to_play[3] = "dlc12.camp.vortex.flyby.skv.ikit.003";
	advice_to_play[4] = "dlc12.camp.vortex.flyby.skv.ikit.004";
	advice_to_play[5] = "dlc12.camp.vortex.flyby.skv.ikit.005";
	advice_to_play[6] = "dlc12.camp.vortex.flyby.skv.ikit.006";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		117,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_skv_clan_skyre/scenes/wh2_main_skv_clan_skyre.CindyScene", 0, 9);
		end,
		0
	);
