...
do
	local enemy_faction_str = "wh2_main_def_ssildra_tor";
	local ally_faction_str = "wh2_main_def_drackla_coven";
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		-- The insufferable Elves of this wasteland see fit to make war upon me. In Settra’s name, I shall have my legions march and choke their fortresses in sand. None shall stand against the Mortuary Cult!
		"dlc09.camp.vortex.khatep.early_game.001",
		nil, 
		"dlc09_main_tmb_khatep_early_game_capture_settlement",
		"PRIEST_NERUTEP",
		"wh2_main_vor_ashen_coast_titan_peak",
		enemy_faction_str,
		{
			"money 1000",
	...
	start_early_game_capture_province_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_capture_province",
		"PRIEST_NERUTEP",
		{
			"money 2000",
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_enact_commandment",
		"PRIEST_NERUTEP",
		{
			"money 500"
		}
	...
	start_early_game_search_ruins_mission_listener(		
		...
		9,
		"dlc09_main_tmb_khatep_early_game_search_ruins",
		"PRIEST_NERUTEP",
		{
			"money 500",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_rogue_armies",
		"PRIEST_NERUTEP",
		"wh2_main_rogue_teef_snatchaz",
		{
			{v(45, 489), scarpels_lair_region_str},
			{v(47, 536), tyrant_peak_region_str},
			{v(61, 559), tyrant_peak_region_str}
		},
	...
	start_early_game_research_tech_mission_listener(
		...
		"dlc09_main_tmb_khatep_early_game_research_dynasty",
		"PRIEST_NERUTEP",
		{
			"money 1000"
		},
	...
	start_early_game_eliminate_faction_mission_listener(
		-- The enemy recoils before your legions. Destroy these idealistic pretenders!
		"dlc09.camp.vortex.advice.early_game.eliminate_faction.006",
		nil,
		"dlc09_main_tmb_khatep_early_game_eliminate_faction",
		"PRIEST_NERUTEP",
		enemy_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_upgrade_settlement_part_two",
		"PRIEST_NERUTEP",
		scarpels_lair_region_str,
		{
	...
	start_early_game_hero_technology_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_khatep_early_game_hero_technology_mission", 
		"PRIEST_NERUTEP", 
		{
			"money 500",
			"faction_pooled_resource_transaction{resource tmb_canopic_jars;factor wh2_main_resource_factor_missions;amount " .. early_game_growth_point_mission_canopic_jars_payload_amount .. ";}"
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_hero_recruitment_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_hero_action_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_raise_army_mission",
		"PRIEST_NERUTEP",
		{
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_non_aggression_pact",
		"PRIEST_NERUTEP",
		ally_faction_str, 
		10,
		{
	...
	start_early_game_trade_agreement_mission_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_trade_agreement",
		"PRIEST_NERUTEP",
		ally_faction_str,
		3,
		12,
	...
	start_early_game_resources_mission_listener(
		...
		nil, 
		"wh2_main_vor_grey_guardians_sulpharets",
		3, 
		"dlc09_main_tmb_khatep_early_game_resources", 
		"res_animals", 
		"PRIEST_NERUTEP", 
		{
			"money 500",
	...
	start_early_game_pooled_resource_mission_listener(
		...
		"dlc09_main_tmb_khatep_early_game_canopic_jars",
		"tmb_canopic_jars",
	...
	start_early_game_mortuary_cult_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_khatep_early_game_mortuary_cult", 
		"PRIEST_NERUTEP", 
		{
			"money 1000",
	...
	start_early_game_tmb_recruitment_building_mission_listener(
		...
		nil, 
		"dlc09_main_tmb_khatep_early_game_recruitment_building",
		2,
		{
	...
	start_early_game_tmb_recruitment_building_guide_listener(
		...
		nil,
		"dlc09_main_tmb_khatep_early_game_recruit_capless_units",
		8,
		"PRIEST_NERUTEP", 
		{
			"money 500",
