...
function cutscene_intro_play()
	...
	advice_to_play[1] = "dlc09.camp.vortex.khatep.intro.001";
	advice_to_play[2] = "dlc09.camp.vortex.khatep.intro.002";
	advice_to_play[3] = "dlc09.camp.vortex.khatep.intro.003";
	advice_to_play[4] = "dlc09.camp.vortex.khatep.intro.004";
	advice_to_play[5] = "dlc09.camp.vortex.khatep.intro.005";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		118.5,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc09_tmb_exiles_of_nehek/scenes/exiles_of_nehek_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
