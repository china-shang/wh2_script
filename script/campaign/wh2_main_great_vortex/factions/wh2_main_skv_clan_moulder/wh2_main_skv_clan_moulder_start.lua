...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc16.camp.vortex.flyby.throt.001";
	advice_to_play[2] = "wh2_dlc16.camp.vortex.flyby.throt.002";
	advice_to_play[3] = "wh2_dlc16.camp.vortex.flyby.throt.003";
	advice_to_play[4] = "wh2_dlc16.camp.vortex.flyby.throt.004";
	advice_to_play[5] = "wh2_dlc16.camp.vortex.flyby.throt.005";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",							-- string name for this cutscene
		96,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_skv_clan_moulder/scenes/flyby.CindyScene", 0, 5);
		end,
		0
	);
