...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc17.camp.vortex.flyby.oxyotl.001";
	advice_to_play[2] = "wh2_dlc17.camp.vortex.flyby.oxyotl.002";
	advice_to_play[3] = "wh2_dlc17.camp.vortex.flyby.oxyotl.003";
	advice_to_play[4] = "wh2_dlc17.camp.vortex.flyby.oxyotl.004";
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc17_lzd_oxyotl/scenes/vortex_oxyotl_flyby_01.CindyScene", 0, 10);
		end,
		0
	);
	...
	-- we have cut advice line 3 in order to streamline the flyover - This still needs to be called 004 though for audio purposes.
	cutscene_intro:action(
		function()
