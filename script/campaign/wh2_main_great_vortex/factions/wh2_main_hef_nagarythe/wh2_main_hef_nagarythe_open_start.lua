...
do
	...
	do
		local char_cqi = cm:get_cached_value(
			...
			function()
				local character = cm:get_faction(karond_kar_faction_str):faction_leader();
				if character then
	...
	start_early_game_capture_enemy_settlement_mission_listener(
		...
		"wh2_dlc10.camp.vortex.alith_anar.early_game.001",
		nil, 
		"wh2_main_hef_alith_anar_early_game_capture_settlement",
		"LOREMASTER_TALARIAN",
		slavers_point_region_str,
		karond_kar_faction_str,
		{
			"money 1000",
			"influence 2",
	...
	start_early_game_capture_province_mission_listener(
		...
		"wh2_dlc10.camp.vortex.alith_anar.early_game.003",
		nil,
		"wh2_main_hef_alith_anar_early_game_capture_province",
		"LOREMASTER_TALARIAN",
		{
			"money 2000",
			"influence 5",
	...
	start_early_game_upgrade_settlement_mission_listener(
		-- "wh2_dlc10.camp.vortex.alith_anar.early_game.002",
		"wh2_main_hef_alith_anar_early_game_upgrade_settlement",
		"LOREMASTER_TALARIAN",
		"wh2_main_hef_settlement_minor_2_coast",
		"wh2_main_vor_the_broken_land_slavers_point",
		{
			"money 500",
			"influence 5",
			"faction_pooled_resource_transaction{resource wh2_main_ritual_currency;factor wh2_main_resource_factor_missions;amount " .. early_game_capture_province_mission_ritual_currency_payload_amount .. ";}"
	...
	start_early_game_enact_commandment_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_enact_commandment",
		"LOREMASTER_TALARIAN",
		{
			"money 500",
			"influence 2"
	...
	--start_early_game_search_ruins_mission_listener(		
		...
		--6,
		--"wh2_main_hef_alith_anar_early_game_search_ruins",
		--"LOREMASTER_TALARIAN",
		--{
		--	"money 500",
		--	"influence 1",
	...
	start_early_game_rogue_army_mission_listener(
		...
		nil, 
		"wh2_main_hef_alith_anar_early_game_rogue_armies",
		"LOREMASTER_TALARIAN",
		"wh2_main_rogue_teef_snatchaz", 
		{
			{v(343, 611), "wh2_main_vor_the_broken_land_black_creek_spire"},
			{v(348, 605), "wh2_main_vor_the_broken_land_black_creek_spire"},
			{v(356, 608), "wh2_main_vor_the_broken_land_black_creek_spire"},
			{v(360, 605), "wh2_main_vor_the_broken_land_black_creek_spire"}
		},
	...
	start_early_game_tech_building_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_construct_tech_building",
		"LOREMASTER_TALARIAN",
		{
	...
	start_early_game_research_tech_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_research_tech",
		"LOREMASTER_TALARIAN",
		{
			"money 500",
			"influence 1"
	...
	start_early_game_public_order_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_public_order",
		"LOREMASTER_TALARIAN",
	...
	start_early_game_eliminate_faction_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_eliminate_faction",
		"LOREMASTER_TALARIAN",
		karond_kar_faction_str,
		1,
		25,
	...
	start_early_game_growth_point_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_upgrade_settlement_part_two",
		"LOREMASTER_TALARIAN",
		"wh2_main_vor_nagarythe_tor_dranil",
		"wh2_main_hef_settlement_minor_2",
		"wh2_main_hef_settlement_minor_3",
		{
			"money 1000",
			"influence 1",
	...
	start_early_game_hero_building_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_hero_building_mission",
		"LOREMASTER_TALARIAN",
		{
	...
	start_early_game_hero_recruitment_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_hero_recruitment_mission",
		"LOREMASTER_TALARIAN",
		{
			"influence 1",
	...
	start_early_game_hero_action_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_hero_action_mission",
		"LOREMASTER_TALARIAN",
		{
			"influence 1",
	...
	start_early_game_raise_army_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_raise_army_mission",
		"LOREMASTER_TALARIAN",
		{
			"influence 2",
	...
	start_early_game_non_aggression_pact_mission_listener(
		...
		nil,
		"wh2_main_hef_alith_anar_early_game_non_aggression_pact", 
		"LOREMASTER_TALARIAN",
	...
	start_early_game_trade_agreement_mission_listener(
		...
		"wh2_main_hef_alith_anar_early_game_trade_agreement",
		"LOREMASTER_TALARIAN",
		"wh2_main_hef_tiranoc",
		3,
		12,
	...
	do
		...
		local advice_to_show = {
			-- Far to the west lies the Druchii shrine of Vaul's Anvil, my Lord. From it emanates a great and terrible power, yet the grounds around the shrine are surely rich with the Way-fragments you seek.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.100",
			-- The shrine will be well-defended, yet a strike against it is vital if enough Way-fragments are to be secured to prevent the collapse of the Vortex.
			"wh2.camp.vortex.advice.early_game.ritual_settlements.101"
		};
		...
		start_early_game_ritual_settlement_capture_mission_listener(
			...
			nil, 
			0.5, 
			"wh2_main_hef_alith_anar_early_game_capture_ritual_settlement",
			"LOREMASTER_TALARIAN",
			ritual_region_key, 
			12,
			{
		...
		start_early_game_ritual_building_mission_listener(
			-- Vaul's Anvil is yours, my Lord. My scrying reveals a great number of Way-fragments buried in the area. I urge you to construct facilities to begin extraction of these at the first opportunity, for the power of the Vortex dims further.
			"wh2_dlc10.camp.vortex.early_game.ritual_buildings.110", 
			nil,
			"wh2_main_hef_alith_anar_early_game_construct_ritual_building",
			"LOREMASTER_TALARIAN",
			ritual_region_key, 
	...
	do
		...
		local enact_ritual_mission_key = "wh2_main_hef_alith_anar_early_game_enact_ritual";
		...
		start_early_game_ritual_currency_mission_listener(
			...
			"wh2_dlc10.camp.vortex.alith_anar.early_game.004",
			{
				1,
			...
			300,
			"wh2_main_hef_alith_anar_early_game_earn_ritual_currency",
			"LOREMASTER_TALARIAN",
		...
		start_early_game_ritual_mission_listener(
			...
			"wh2_dlc10.camp.vortex.alith_anar.early_game.005",
			nil,
			ritual_trigger_currency_threshold,
			enact_ritual_mission_key,
			enact_ritual_mission_issuer,
