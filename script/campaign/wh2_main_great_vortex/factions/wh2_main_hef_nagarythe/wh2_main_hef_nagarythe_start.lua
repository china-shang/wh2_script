...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc10.camp.vortex.alith_anar.intro.001";
	advice_to_play[2] = "wh2_dlc10.camp.vortex.alith_anar.intro.002";
	advice_to_play[3] = "wh2_dlc10.camp.vortex.alith_anar.intro.003";
	advice_to_play[4] = "wh2_dlc10.camp.vortex.alith_anar.intro.004";
	advice_to_play[5] = "wh2_dlc10.camp.vortex.alith_anar.intro.005";
	
	local cutscene_intro_length = 70.0;
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_hef_nagarythe/scenes/nagarythe_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
