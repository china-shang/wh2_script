...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2.camp.vortex.skrolk.intro.001";
	advice_to_play[2] = "wh2.camp.vortex.skrolk.intro.002";
	advice_to_play[3] = "wh2.camp.vortex.skrolk.intro.003";
	advice_to_play[4] = "wh2.camp.vortex.skrolk.intro.004";
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_main_skv_clan_pestilens/scenes/clan_pestilens_flyover_s01.CindyScene", 0, 5);
		end,
		0
	);
