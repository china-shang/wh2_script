...
function cutscene_intro_play()
	...
	advice_to_play[1] = "wh2_dlc16.camp.vortex.flyby.sisters.001";
	advice_to_play[2] = "wh2_dlc16.camp.vortex.flyby.sisters.002";
	advice_to_play[3] = "wh2_dlc16.camp.vortex.flyby.sisters.003";
	advice_to_play[4] = "wh2_dlc16.camp.vortex.flyby.sisters.004";
	advice_to_play[5] = "wh2_dlc16.camp.vortex.flyby.sisters.005";
	
	local cutscene_intro = campaign_cutscene:new(
		cm:get_local_faction_name(true) .. "_intro",					-- string name for this cutscene
		66.5,															-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/wh2_main_great_vortex/factions/wh2_dlc16_wef_sisters_of_twilight/scenes/flyby.CindyScene", 0, 5);
		end,
		0
	);
...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		cm:make_region_seen_in_shroud("wh2_dlc16_wef_sisters_of_twilight", "wh2_main_vor_the_black_coast_hag_hall");
		cm:make_region_seen_in_shroud("wh2_dlc16_wef_sisters_of_twilight", "wh2_main_vor_shadow_wood_venom_glade");
		cm:make_region_seen_in_shroud("wh2_dlc16_wef_sisters_of_twilight", "wh2_main_vor_shadow_wood_clar_karond");
		-- set enemy faction personality

		cm:force_change_cai_faction_personality("wh2_dlc16_grn_naggaroth_orcs", "wh_script_foolishly_brave");
