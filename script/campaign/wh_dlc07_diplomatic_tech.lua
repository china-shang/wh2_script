...
function Check_Bretonnia_Technology(faction)
	...
	if Is_Bretonnian(faction_name) and faction_name ~= "wh2_dlc14_brt_chevaliers_de_lyonesse" then
...
bret_confederation_dilemmas = {
	{tech = "tech_dlc07_brt_heraldry_artois", dilemma = "wh_dlc07_brt_confederation_artois", faction = "wh_main_brt_artois"},
	{tech = "tech_dlc07_brt_heraldry_bastonne", dilemma = "wh_dlc07_brt_confederation_bastonne", faction = "wh_main_brt_bastonne"},
	{tech = "tech_dlc07_brt_heraldry_bordeleaux", dilemma = "wh_dlc07_brt_confederation_bordeleaux", faction = "wh_main_brt_bordeleaux"},
	{tech = "tech_dlc07_brt_heraldry_bretonnia", dilemma = "wh_dlc07_brt_confederation_bretonnia", faction = "wh_main_brt_bretonnia"},
	{tech = "tech_dlc07_brt_heraldry_carcassonne", dilemma = "wh_dlc07_brt_confederation_carcassonne", faction = "wh_main_brt_carcassonne"},
	{tech = "tech_dlc07_brt_heraldry_lyonesse", dilemma = "wh_dlc07_brt_confederation_lyonesse", faction = "wh_main_brt_lyonesse"},
	{tech = "tech_dlc07_brt_heraldry_parravon", dilemma = "wh_dlc07_brt_confederation_parravon", faction = "wh_main_brt_parravon"}
};